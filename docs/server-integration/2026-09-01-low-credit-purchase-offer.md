...
后续合同：首充已扩展为订阅 5 折／加油包 8 折共享一次且不限时，见 [2026-09-14 适配说明](2026-09-14-low-credit-purchase-guide.md)；成功付款口径与旧返购资格纠正以[2026-09-15 成功付款资格说明](2026-09-15-successful-payment-offer-eligibility.md)为准。本文其他接口及历史记录保留。
...
- 无符合当前成功付款口径的个人订单、个人可用积分 0～100：首充订阅 5 折／加油包 8 折共享一次，不限时。
- 历史个人付费用户、个人可用积分 0～500：9 折。
- 活跃订阅用户的 9 折仅适用于加油包；非活跃历史付费用户适用于订阅和加油包。
- 成功付款必须同时满足 `payment_orders.status='paid'`、`paid_at IS NOT NULL`、`order_type IN ('subscription','boost_pack')`、`tob_enterprise_id IS NULL`；`refunding`、`refunded` 及其他非 `paid` 状态均排除。
