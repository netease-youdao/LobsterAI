...
const PROVIDER_DEFINITIONS = [
  ...
  {
    id: ProviderName.OrcaRouter,
    label: 'OrcaRouter',
    website: 'https://www.orcarouter.ai',
    apiKeyUrl: 'https://www.orcarouter.ai/register',
    openClawProviderId: OpenClawProviderId.OpenRouter,
    ...
    enPriority: 0,
    defaultModels: [
      { id: 'anthropic/claude-sonnet-5', name: 'Claude Sonnet 5', supportsImage: true, supportsThinking: true, contextWindow: 1_000_000 },
      { id: 'anthropic/claude-opus-5', name: 'Claude Opus 5', supportsImage: true, supportsThinking: true, contextWindow: 1_000_000 },
      { id: 'anthropic/claude-haiku-4.5', name: 'Claude Haiku 4.5', supportsImage: true, supportsThinking: true, contextWindow: 200_000 },
    ],
  },
