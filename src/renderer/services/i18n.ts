...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    scheduledTasksUnsavedTitle: '未保存的修改',
    scheduledTasksUnsavedMessage: '你有未保存的修改，离开后将丢失。确认离开吗？',
    scheduledTasksUnsavedLeave: '离开',
    scheduledTasksUnsavedStay: '继续编辑',
  ...
  en: {
    ...
    scheduledTasksUnsavedTitle: 'Unsaved Changes',
    scheduledTasksUnsavedMessage: 'You have unsaved changes that will be lost if you leave. Are you sure?',
    scheduledTasksUnsavedLeave: 'Leave',
    scheduledTasksUnsavedStay: 'Keep Editing',
