...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    artifactImageAlt: '图片',
    imageEditorOpen: '编辑图片',
    imageEditorTitle: '图片画板',
    imageEditorComment: '标注',
    imageEditorRemove: '涂抹删除',
    imageEditorCommentHint: '点击图片添加编号标注，再填写修改要求',
    imageEditorRemoveHint: '在图片上涂抹需要删除并自然补全的区域',
    imageEditorBrushSize: '画笔大小',
    imageEditorUndo: '撤销',
    imageEditorRedo: '重做',
    imageEditorClear: '清除全部标注',
    imageEditorZoomOut: '缩小',
    imageEditorZoomIn: '放大',
    imageEditorResetZoom: '重置缩放',
    imageEditorComments: '标注说明',
    imageEditorNoComments: '还没有标注，点击图片添加',
    imageEditorCommentLabel: '标注 {number}',
    imageEditorCommentPlaceholder: '描述这里需要如何修改',
    imageEditorDeleteComment: '删除此标注',
    imageEditorAspectRatio: '目标比例',
    imageEditorRatioOriginal: '保持原比例',
    imageEditorRatioSquare: '方形 · 1:1',
    imageEditorRatioPortrait: '竖版 · 3:4',
    imageEditorRatioStory: '故事 · 9:16',
    imageEditorRatioLandscape: '横版 · 4:3',
    imageEditorRatioWidescreen: '宽屏 · 16:9',
    imageEditorInstructions: '补充要求',
    imageEditorInstructionsPlaceholder: '例如：整体光线更柔和，保持人物不变',
    imageEditorEmpty: '请先添加标注、删除区域、目标比例或补充要求',
    imageEditorPreparing: '正在准备...',
    imageEditorAddToPrompt: '添加到输入框',
    imageEditorPrepareFailed: '无法读取或导出这张图片，请尝试使用本地图片',
    imageEditorDraftReady: '图片编辑要求已添加到输入框',
    artifactFiles: '文件',
  ...
  en: {
    ...
    imageEditorOpen: 'Edit image',
    imageEditorTitle: 'Image canvas',
    imageEditorComment: 'Comment',
    imageEditorRemove: 'Remove area',
    imageEditorCommentHint: 'Click the image to add a numbered marker, then describe the change',
    imageEditorRemoveHint: 'Paint over areas that should be removed and reconstructed',
    imageEditorBrushSize: 'Brush size',
    imageEditorUndo: 'Undo',
    imageEditorRedo: 'Redo',
    imageEditorClear: 'Clear all annotations',
    imageEditorZoomOut: 'Zoom out',
    imageEditorZoomIn: 'Zoom in',
    imageEditorResetZoom: 'Reset zoom',
    imageEditorComments: 'Comments',
    imageEditorNoComments: 'No comments yet. Click the image to add one.',
    imageEditorCommentLabel: 'Comment {number}',
    imageEditorCommentPlaceholder: 'Describe what should change here',
    imageEditorDeleteComment: 'Delete this comment',
    imageEditorAspectRatio: 'Target ratio',
    imageEditorRatioOriginal: 'Keep original ratio',
    imageEditorRatioSquare: 'Square · 1:1',
    imageEditorRatioPortrait: 'Portrait · 3:4',
    imageEditorRatioStory: 'Story · 9:16',
    imageEditorRatioLandscape: 'Landscape · 4:3',
    imageEditorRatioWidescreen: 'Widescreen · 16:9',
    imageEditorInstructions: 'Additional instructions',
    imageEditorInstructionsPlaceholder: 'For example: soften the light and keep the person unchanged',
    imageEditorEmpty: 'Add a comment, removal area, target ratio, or instruction first',
    imageEditorPreparing: 'Preparing...',
    imageEditorAddToPrompt: 'Add to prompt',
    imageEditorPrepareFailed: 'This image could not be read or exported. Try a local image instead.',
    imageEditorDraftReady: 'Image edit instructions were added to the prompt',
    artifactFiles: 'Files',
