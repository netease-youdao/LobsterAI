...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    remoteRenameHint: '仅修改有道龙虾中的显示名称，最多 100 个字符。确认后，点击设置页底部“保存”生效。',
  ...
  en: {
    ...
    remoteAllowConnection: 'Allow mobile connections',
    ...
    remoteKeepAwake: 'Keep computer awake',
    ...
    remoteRenameHint: 'Changes only the display name in LobsterAI, up to 100 characters. Confirm, then select Save at the bottom of settings to apply.',
