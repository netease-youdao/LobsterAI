...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    skillRecent: '最近使用',
    skillRecentEmpty: '暂无使用记录',
    skillUsageCount: '已使用 {count} 次',
    skillSortRecent: '最近使用',
    skillSortCount: '使用最多',
  ...
  en: {
    ...
    skillRecent: 'Recent',
    skillRecentEmpty: 'No recent skills',
    skillUsageCount: 'Used {count} times',
    skillSortRecent: 'Recently used',
    skillSortCount: 'Most used',
