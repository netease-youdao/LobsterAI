...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    agentAddNew: '新建 Agent',
    agentNameLabel: 'Agent 名称',
    agentNamePlaceholder: '例如：代码助手',
    agentWorkDirLabel: '工作目录',
    agentWorkDirPlaceholder: '选择工作目录...',
    agentSystemPromptLabel: '系统提示词',
    agentSystemPromptPlaceholder: '给 Agent 的全局指令...',
    agentExecutionModeLabel: '执行模式',
    agentIdentityLabel: 'Agent 身份',
    agentIdentityHint: 'Agent 的基本信息（名字、emoji、头像等元数据）',
    agentSoulLabel: 'Agent 人设',
    agentSoulHint: 'Agent 的性格、语气和行为准则。会强制 Agent 遵循此设定。',
    agentStoragePath: '存储路径：',
    agentUserLabel: '用户档案',
    agentUserHint: '关于你自己的信息（姓名、偏好等），Agent 会记住你。',
    agentAvatarLabel: '头像',
    agentAvatarPlaceholder: '🤖',
    agentListExpand: '展开列表',
    agentListCollapse: '收起列表',
    agentInvocableLabel: '允许被其他 Agent 调用',
    agentInvocableHint: '开启后，其他 Agent 可通过 invoke_agent 工具调用此 Agent 完成子任务。',
    agentSaveBtn: '保存',
    agentSavedOk: 'Agent 设定已保存',
    agentSaveFailed: 'Agent 设定保存失败',
    agentDeleteBtn: '删除',
    agentDeleteConfirm: '确认删除此 Agent？此操作不可撤销。',
    agentActiveLabel: '当前激活',
    agentSetActive: '设为当前 Agent',
    agentNewDefaultName: '新 Agent',
    agentSelectToEdit: '请从左侧选择一个 Agent 进行编辑',
    ...
    coworkExecutionModeLocal: '本地执行',
    coworkExecutionModeAuto: '自动',
    coworkExecutionModeSandbox: '沙箱隔离',
    orchLogSpawning: '执行中...',
    orchLogDone: '任务完成',
    refresh: '刷新',
    subTaskRoleTool: '工具调用',
    orchLogFailed: '任务失败',
    orchLogRunningBackground: '子 Agent 后台执行中',
    orchLogTimeout: '任务超时',
    subTaskDetail: '子任务详情',
  ...
  en: {
    ...
    agentAddNew: 'New Agent',
    agentNameLabel: 'Agent Name',
    agentNamePlaceholder: 'e.g. Coder',
    agentWorkDirLabel: 'Working Directory',
    agentWorkDirPlaceholder: 'Select working directory...',
    agentSystemPromptLabel: 'System Prompt',
    agentSystemPromptPlaceholder: 'Global instructions for this Agent...',
    agentExecutionModeLabel: 'Execution Mode',
    agentIdentityLabel: 'Agent Identity',
    agentIdentityHint: 'Agent metadata (name, emoji, avatar, etc.)',
    agentSoulLabel: 'Agent Soul',
    agentSoulHint: 'Agent personality, tone, and behavior guidelines. The Agent will strictly follow this.',
    agentStoragePath: 'Storage path:',
    agentUserLabel: 'User Profile',
    agentUserHint: 'Information about you (name, preferences, etc.) — the Agent will remember you.',
    agentAvatarLabel: 'Avatar',
    agentAvatarPlaceholder: '🤖',
    agentListExpand: 'Expand list',
    agentListCollapse: 'Collapse list',
    agentInvocableLabel: 'Allow invocation by other agents',
    agentInvocableHint: 'When enabled, other agents can call this agent via the invoke_agent tool to complete sub-tasks.',
    agentSaveBtn: 'Save',
    agentSavedOk: 'Agent settings saved',
    ...
    agentActiveLabel: 'Active',
    agentSetActive: 'Set as Active Agent',
    agentNewDefaultName: 'New Agent',
    agentSelectToEdit: 'Select an Agent from the list to edit',
    ...
    coworkExecutionModeLocal: 'Local',
    coworkExecutionModeAuto: 'Auto',
    coworkExecutionModeSandbox: 'Sandbox',
    orchLogSpawning: 'Running...',
    orchLogDone: 'Task completed',
    refresh: 'Refresh',
    subTaskRoleTool: 'Tool Call',
    orchLogFailed: 'Task failed',
    orchLogRunningBackground: 'Sub-agent running in background',
    orchLogTimeout: 'Task timed out',
    subTaskDetail: 'Sub-task Detail',
    subTaskNoHistory: 'No conversation history',
    subTaskRoleUser: 'Task Instruction',
    subTaskMessages: 'messages',
    subTaskToolProcessing: 'Processing...',
    subTaskToolDone: 'Completed',
