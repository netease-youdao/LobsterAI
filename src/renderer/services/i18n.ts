...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    onboardingPrev: '上一步',
    onboardingDone: '完成',
    onboardingWelcomeTitle: '欢迎使用 LobsterAI',
    onboardingWelcomeDesc: '这是侧边栏，你可以在这里管理对话、切换智能体和访问各个功能模块。',
    onboardingNewChatTitle: '新建对话',
    onboardingNewChatDesc: '点击这里开始一个新的 AI 对话。你也可以使用快捷键快速创建。',
    onboardingSidebarNavTitle: '功能导航',
    onboardingSidebarNavDesc:
      '在这里可以快速切换到定时任务、技能管理、MCP 服务器和智能体等功能模块。',
    onboardingModelSelectorTitle: '模型选择',
    onboardingModelSelectorDesc: '点击这里切换不同的 AI 模型。使用前需要先在设置中配置模型供应商。',
    onboardingPromptInputTitle: '输入区域',
    onboardingPromptInputDesc: '在这里输入你的问题或指令。支持文件附件、技能激活和工作目录选择。',
    onboardingSettingsTitle: '设置',
    onboardingSettingsDesc: '点击这里打开设置面板，配置模型供应商、主题、快捷键等。',
    onboardingModelTabTitle: '模型设置',
    onboardingModelTabDesc:
      '这是模型配置页面。在这里添加和管理 AI 模型供应商，开始使用 LobsterAI。',
    onboardingProviderListTitle: '模型供应商列表',
    onboardingProviderListDesc:
      '选择一个模型供应商（如 OpenAI、DeepSeek 等），点击右侧开关启用它。',
    onboardingProviderSettingsTitle: '供应商配置',
    onboardingProviderSettingsDesc:
      '在这里填写 API Key 和其他配置。配置完成后开启供应商开关即可使用。',
    onboardingSaveSettingsTitle: '保存设置',
    onboardingSaveSettingsDesc: '配置完成后，点击保存按钮使设置生效。',
    onboardingResetTour: '新手引导',
    onboardingResetBtn: '重新开始',
    onboardingResetDone: '新手引导已重置，重新进入页面后将再次展示。',
  ...
  en: {
    ...
    onboardingDone: 'Done',
    onboardingWelcomeTitle: 'Welcome to LobsterAI',
    onboardingWelcomeDesc:
      'This is the sidebar where you can manage conversations, switch agents, and access all feature modules.',
    onboardingNewChatTitle: 'New Chat',
    onboardingNewChatDesc:
      'Click here to start a new AI conversation. You can also use keyboard shortcuts.',
    onboardingSidebarNavTitle: 'Navigation',
    onboardingSidebarNavDesc:
      'Quickly switch between Scheduled Tasks, Skills, MCP Servers, Agents, and more.',
    onboardingModelSelectorTitle: 'Model Selector',
    onboardingModelSelectorDesc:
      'Click here to switch between different AI models. You need to configure a model provider in Settings first.',
    onboardingPromptInputTitle: 'Input Area',
    onboardingPromptInputDesc:
      'Type your questions or instructions here. Supports file attachments, skill activation, and working directory selection.',
    onboardingSettingsTitle: 'Settings',
    onboardingSettingsDesc:
      'Click here to open the Settings panel to configure model providers, themes, shortcuts, and more.',
    onboardingModelTabTitle: 'Model Settings',
    onboardingModelTabDesc:
      'This is the model configuration page. Add and manage AI model providers here to get started with LobsterAI.',
    onboardingProviderListTitle: 'Provider List',
    onboardingProviderListDesc:
      'Select a model provider (e.g., OpenAI, DeepSeek) and toggle the switch to enable it.',
    onboardingProviderSettingsTitle: 'Provider Configuration',
    onboardingProviderSettingsDesc:
      'Enter your API Key and other settings here. Enable the provider toggle after configuration to start using it.',
    onboardingSaveSettingsTitle: 'Save Settings',
    onboardingSaveSettingsDesc: 'Click the Save button to apply your configuration changes.',
    onboardingResetTour: 'Onboarding Tour',
    onboardingResetBtn: 'Restart',
    onboardingResetDone:
      'Onboarding tour has been reset. It will appear again when you re-enter the page.',
