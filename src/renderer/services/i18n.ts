...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    coworkExecutionModeTitle: '执行模式',
    coworkExecutionModeHint: '控制工具执行时的沙箱隔离级别，影响文件系统和网络访问权限。',
    coworkExecutionMode_auto: '自动（推荐）',
    coworkExecutionMode_auto_hint: '主会话不隔离，IM 频道等非主会话在沙箱中运行。',
    coworkExecutionMode_local: '本地',
    coworkExecutionMode_local_hint: '所有工具直接在本地执行，无沙箱隔离。适合完全信任的个人使用场景。',
    coworkExecutionMode_sandbox: '沙箱',
    coworkExecutionMode_sandbox_hint: '所有会话均在 Docker 沙箱中运行，最大程度隔离风险。需要本机安装 Docker。',
  ...
  en: {
    ...
    coworkExecutionModeTitle: 'Execution Mode',
    coworkExecutionModeHint: 'Controls the sandbox isolation level for tool execution, affecting file system and network access.',
    coworkExecutionMode_auto: 'Auto (Recommended)',
    coworkExecutionMode_auto_hint: 'Main session runs without isolation; IM channel and other non-main sessions run in a sandbox.',
    coworkExecutionMode_local: 'Local',
    coworkExecutionMode_local_hint: 'All tools execute directly on the local machine with no sandbox. For fully trusted personal use.',
    coworkExecutionMode_sandbox: 'Sandbox',
    coworkExecutionMode_sandbox_hint: 'All sessions run inside Docker containers for maximum isolation. Requires Docker installed locally.',
    coworkAgentEngineClaudeLegacy: 'Cowork',
