...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    agentAvatar: '头像',
    agentAvatarHint: '支持上传图片头像，也可以直接使用 Emoji 头像。',
    agentAvatarTabImage: '图片',
    agentAvatarTabEmoji: 'Emoji',
    agentAvatarCurrentImage: '当前显示图片头像',
    agentAvatarCurrentEmoji: '当前使用 Emoji 头像',
    agentAvatarCurrentImageHint: '上传的图片会优先显示；删除图片后会显示你选择的 Emoji。',
    agentAvatarCurrentEmojiHint: '如果不上传图片，当前 Emoji 就会作为头像显示。',
    agentAvatarPreviewActionImage: '点击更换图片',
    agentAvatarPreviewActionUploadImage: '点击上传图片',
    agentAvatarPreviewActionEmoji: '点击选择 Emoji',
    agentAvatarImageHint: '想让 Agent 更有辨识度时，可以上传一张图片头像。',
    agentAvatarEmojiHintWithImage: '你仍然可以在这里调整 Emoji；图片被移除或不可用时会自动显示它。',
    agentAvatarEmojiHintWithoutImage: '直接选择一个 Emoji 作为头像，适合快速区分不同 Agent。',
    agentAvatarUseEmojiInstead: '移除图片，使用 Emoji',
    agentAvatarFallbackEmoji: 'Emoji 头像',
    agentAvatarUpload: '上传图片',
    agentAvatarReplace: '更换图片',
    agentAvatarRemoveImage: '移除图片',
    agentAvatarUploadTitle: '选择头像图片',
    agentAvatarImageFiles: '图片文件',
    agentAvatarReadFailed: '读取头像图片失败',
    agentAvatarUnsupportedType: '头像图片格式不受支持',
    agentAvatarFileTooLarge: '头像图片不能超过 {size} MB',
    agentAvatarImportFailed: '导入头像图片失败',
     agentName: '名称',
  ...
  en: {
    ...
    agentAvatar: 'Avatar',
    agentAvatarHint: 'Upload an image avatar or use an emoji avatar.',
    agentAvatarTabImage: 'Image',
    agentAvatarTabEmoji: 'Emoji',
    agentAvatarCurrentImage: 'Image avatar is active',
    agentAvatarCurrentEmoji: 'Emoji avatar is active',
    agentAvatarCurrentImageHint: 'Your uploaded image is shown first. If you remove it, the selected emoji will be shown.',
    agentAvatarCurrentEmojiHint: 'Without an uploaded image, the selected emoji will be shown as the avatar.',
    agentAvatarPreviewActionImage: 'Click to replace image',
    agentAvatarPreviewActionUploadImage: 'Click to upload image',
    agentAvatarPreviewActionEmoji: 'Click to choose emoji',
    agentAvatarImageHint: 'Upload an image when you want a more personalized agent portrait.',
    agentAvatarEmojiHintWithImage: 'You can still adjust the emoji here. It will appear automatically if the image is removed or unavailable.',
    agentAvatarEmojiHintWithoutImage: 'Pick an emoji for a quick avatar that is easy to recognize in lists and sidebars.',
    agentAvatarUseEmojiInstead: 'Remove image and use emoji',
    agentAvatarFallbackEmoji: 'Emoji avatar',
    agentAvatarUpload: 'Upload image',
    agentAvatarReplace: 'Replace image',
    agentAvatarRemoveImage: 'Remove image',
    agentAvatarUploadTitle: 'Select avatar image',
    agentAvatarImageFiles: 'Image files',
    agentAvatarReadFailed: 'Failed to read avatar image',
    agentAvatarUnsupportedType: 'Avatar image format is not supported',
    agentAvatarFileTooLarge: 'Avatar image must be smaller than {size} MB',
    agentAvatarImportFailed: 'Failed to import avatar image',
     agentName: 'Name',
