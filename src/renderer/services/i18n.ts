...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    scheduledTasksTabTemplates: '模板',
    scheduledTasksTemplatesHint: '选择一个模板快速创建定时任务',
  ...
  en: {
    ...
    scheduledTasksTabTemplates: 'Templates',
    scheduledTasksTemplatesHint: 'Choose a template to quickly create a scheduled task',
