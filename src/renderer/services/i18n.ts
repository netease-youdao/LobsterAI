...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    coworkAttachmentReferencesTitle: '附件引用',
    coworkAttachmentReferenceClipboardDescription: '当前随本次提问一起发送的粘贴图片附件',
    coworkAttachmentReferenceImageDescription: '当前随本次提问一起发送的图片附件',
    coworkAttachmentReferenceFileDescription: '当前随本次提问一起发送的文件附件',
    coworkAttachmentReferenceInvalidWarning: '以下附件引用已失效，发送时将忽略：{tokens}',
    coworkAttachmentReferenceNoResults: '没有匹配的附件',
    coworkSkillReferencesTitle: '技能引用',
    coworkSlashNoResults: '没有匹配的模板',
    coworkComposerNoMentionResults: '没有匹配的附件或技能',
    coworkComposerNoSlashResults: '没有匹配的模板',
    coworkMentionNoResults: '没有匹配的可引用内容',
    coworkAttachmentClipboardImage: '粘贴图片',
    coworkAttachmentImageFile: '图片文件',
    coworkAttachmentFile: '文件',
  ...
  en: {
    ...
    coworkAttachmentReferencesTitle: 'Attachment references',
    coworkAttachmentReferenceClipboardDescription: 'clipboard image attachment included with this prompt',
    coworkAttachmentReferenceImageDescription: 'image attachment included with this prompt',
    coworkAttachmentReferenceFileDescription: 'file attachment included with this prompt',
    coworkAttachmentReferenceInvalidWarning: 'These attachment references are no longer available and will be ignored when sending: {tokens}',
    coworkAttachmentReferenceNoResults: 'No matching attachments',
    coworkSkillReferencesTitle: 'Skill references',
    coworkSlashNoResults: 'No matching templates',
    coworkComposerNoMentionResults: 'No matching attachments or skills',
    coworkComposerNoSlashResults: 'No matching templates',
    coworkMentionNoResults: 'No matching mention items',
    coworkAttachmentClipboardImage: 'Pasted image',
    coworkAttachmentImageFile: 'Image file',
    coworkAttachmentFile: 'File',
