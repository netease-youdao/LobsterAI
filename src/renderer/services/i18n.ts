...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    settingsSearchNoResults: '没有匹配的设置分类',
    settingsSearchAriaLabel: '搜索设置',
    settingsSearchClear: '清除搜索',
    settingsSearchLexiconGeneral: '主题 外观 语言 本地化 代理 自动启动 开机启动 更新 登录 隐私 theme proxy autolaunch',
    settingsSearchLexiconCoworkAgentEngine: 'OpenClaw 引擎 网关 安装 启动 cowork agent engine gateway',
    settingsSearchLexiconModel: '模型 API 密钥 提供商 连接 测试 自定义 model api key provider',
    settingsSearchLexiconIm: 'IM 机器人 微信 飞书 钉钉 企微 Telegram Discord QQ bot',
    settingsSearchLexiconEmail: '邮件 邮箱 IMAP SMTP 技能 email',
    settingsSearchLexiconCoworkMemory: '记忆 MEMORY memory 条目 上下文',
    settingsSearchLexiconCoworkAgent: 'Agent 智能体 技能 工作区 引导 USER SOUL IDENTITY',
    settingsSearchLexiconShortcuts: '快捷键 键盘 热键 shortcut keyboard hotkey',
    settingsSearchLexiconAbout: '关于 版本 更新 日志 手册 社区 导出 copyright version changelog',
    general: '通用',
    model: '模型',
    shortcuts: '快捷键',
    about: '关于',
  ...
  en: {
    ...
    settingsSearchNoResults: 'No matching settings section',
    settingsSearchAriaLabel: 'Search settings',
    settingsSearchClear: 'Clear search',
    settingsSearchLexiconGeneral: 'theme appearance language locale proxy autolaunch startup update login privacy',
    settingsSearchLexiconCoworkAgentEngine: 'openclaw engine gateway install start cowork agent',
    settingsSearchLexiconModel: 'model api key provider connection test custom',
    settingsSearchLexiconIm: 'im bot wechat feishu dingtalk wework telegram discord qq',
    settingsSearchLexiconEmail: 'email mail imap smtp skill',
    settingsSearchLexiconCoworkMemory: 'memory remembering entries context',
    settingsSearchLexiconCoworkAgent: 'agent skills workspace bootstrap user soul identity',
    settingsSearchLexiconShortcuts: 'shortcuts keyboard hotkey',
    settingsSearchLexiconAbout: 'about version update logs manual community export copyright changelog',
    general: 'General',
    model: 'Model',
    shortcuts: 'Shortcuts',
    about: 'About',
