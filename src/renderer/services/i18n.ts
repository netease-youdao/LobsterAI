...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    digitalEmployeeCatalog: "员工广场",
    digitalEmployeeInstalled: "我的员工",
    expertTeams: "专家团",
    digitalEmployeeTitle: "把专业工作交给合适的团队",
    digitalEmployeeSubtitle: "选择数字员工，或由主理人组织多位专家协作交付。",
    digitalEmployeeSearch: "搜索员工、技能或专家团",
    digitalEmployeeDetails: "查看详情",
    digitalEmployeeOpen: "开始工作",
    digitalEmployeeAdd: "添加员工",
    digitalEmployeeSkills: "配套技能：",
    digitalEmployeeEmpty: "没有找到匹配的员工或专家团",
    digitalEmployeeLoadFailed: "无法加载员工目录，请重新打开此页面。",
    digitalEmployeeCreateFailed: "员工创建失败，请重试。",
    expertTeamMembers: "1 位主理人 · {count} 位专业成员",
    expertTeamCreate: "创建并进入专家团",
    expertTeamCreateFailed: "专家团创建失败，请检查成员配置后重试。",
    expertTeamSavedPending: "专家团已保存，引擎配置尚未确认。恢复引擎后再次进入该专家团即可重试，不会重复创建。",
    expertTeamMissingSkills: "请先安装并启用以下配套技能：",
    expertTeamManageSkills: "管理配套技能",
    expertTeamDelegationNotice: "主理人根据任务委派专业成员，以隔离上下文协作并汇总结果。成员和主理人均可在“我的员工”中配置。",
    capabilityAll: "全部",
    capabilityExpert: "专家套件",
    capabilityPlugin: "工具插件",
    capabilityCategory: "分类",
    capabilityUnavailable: "暂不可安装",
    capabilityPluginSetup: "插件技能包安装后，请按其说明配置所需账户、API 和运行依赖。",
    capabilityLoadFailed: "目录加载失败，请刷新重试。",
    capabilityShowMore: "加载更多",
    capabilitySort: "排序",
    capabilitySortDefault: "推荐顺序",
    capabilitySortName: "名称",
    capabilitySortDownloads: "下载量",
    capabilityLayout: "显示方式",
    capabilityGrid: "网格",
    capabilityList: "列表",
    ...
    mcpHeaders: 'HTTP 请求头',
    mcpToolFilterInclude: '仅启用这些工具',
    mcpToolFilterExclude: '隐藏这些工具',
    mcpToolFilterPlaceholder: '每行一个工具名，支持 * 通配',
    mcpToolFilterHint: '未启用的工具不会发送给模型，可显著减少每次对话的提示词 token。留空表示启用全部工具。',
    mcpParallelToolCalls: '允许并行调用工具',
    mcpParallelToolCallsHint: '仅在该服务支持并发请求时开启；关闭时包含该服务工具的调用会按顺序执行。',
    mcpHeaderKey: '键',
    mcpHeaderValue: '值',
  ...
  en: {
    ...
    digitalEmployeeCatalog: "Employee catalog",
    digitalEmployeeInstalled: "My employees",
    expertTeams: "Expert teams",
    digitalEmployeeTitle: "Choose the right team for the job",
    digitalEmployeeSubtitle: "Choose a digital employee or let a team lead coordinate specialist agents.",
    digitalEmployeeSearch: "Search employees, skills or expert teams",
    digitalEmployeeDetails: "View details",
    digitalEmployeeOpen: "Start working",
    digitalEmployeeAdd: "Add employee",
    digitalEmployeeSkills: "Included skills:",
    digitalEmployeeEmpty: "No matching employees or expert teams",
    digitalEmployeeLoadFailed: "Could not load the employee catalog. Reopen this page to retry.",
    digitalEmployeeCreateFailed: "Could not create the employee. Please retry.",
    expertTeamMembers: "1 lead · {count} specialists",
    expertTeamCreate: "Create and open team",
    expertTeamCreateFailed: "Could not create the team. Check member settings and retry.",
    expertTeamSavedPending: "The team is saved; engine configuration is pending. Reopen the team after restoring the engine to retry without creating duplicates.",
    expertTeamMissingSkills: "Install and enable these required skills first:",
    expertTeamManageSkills: "Manage required skills",
    expertTeamDelegationNotice: "The lead delegates to specialists in isolated contexts and consolidates their results. Configure the lead and members in My employees.",
    capabilityAll: "All",
    capabilityExpert: "Expert kits",
    capabilityPlugin: "Tool plugins",
    capabilityCategory: "Category",
    capabilityUnavailable: "Unavailable",
    capabilityPluginSetup: "After installing a plugin skill package, configure the accounts, APIs and runtime dependencies described in its instructions.",
    capabilityLoadFailed: "Could not load the catalog. Refresh to retry.",
    capabilityShowMore: "Show more",
    capabilitySort: "Sort",
    capabilitySortDefault: "Recommended",
    capabilitySortName: "Name",
    capabilitySortDownloads: "Downloads",
    capabilityLayout: "Layout",
    capabilityGrid: "Grid",
    capabilityList: "List",
    ...
    mcpToolFilterInclude: 'Only enable these tools',
    mcpToolFilterExclude: 'Hide these tools',
    mcpToolFilterPlaceholder: 'One tool name per line, * wildcards supported',
    mcpToolFilterHint: 'Tools that are not enabled are never sent to the model, which cuts prompt tokens on every turn. Leave empty to enable all tools.',
    mcpParallelToolCalls: 'Allow parallel tool calls',
    mcpParallelToolCallsHint: 'Turn on only if this server handles concurrent requests; otherwise tool calls that include this server run one at a time.',
    mcpHeaderKey: 'Key',
