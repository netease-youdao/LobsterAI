...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    markdownEditorOpenLinkHint: '按住 Ctrl 点击打开链接',
    markdownEditorOpenLinkHintMac: '按住 ⌘ 点击打开链接',
    markdownSearchFind: '查找',
    markdownSearchReplace: '替换为',
    markdownSearchNext: '下一个',
    markdownSearchPrevious: '上一个',
    markdownSearchAll: '全部',
    markdownSearchMatchCase: '区分大小写',
    markdownSearchRegexp: '正则表达式',
    markdownSearchByWord: '全字匹配',
    markdownSearchReplaceOne: '替换',
    markdownSearchReplaceAll: '全部替换',
    markdownSearchClose: '关闭',
    markdownSearchCurrentMatch: '当前匹配',
    markdownSearchReplacedMatches: '已替换 $ 处',
    markdownSearchReplacedMatchOnLine: '已替换第 $ 行的匹配项',
    markdownSearchOnLine: '位于行',
    markdownSearchGoToLine: '跳转到行',
    markdownSearchGo: '跳转',
  ...
  en: {
    ...
    markdownEditorOpenLinkHint: 'Ctrl-click to open link',
    markdownEditorOpenLinkHintMac: '⌘-click to open link',
    markdownSearchFind: 'Find',
    markdownSearchReplace: 'Replace',
    markdownSearchNext: 'Next',
    markdownSearchPrevious: 'Previous',
    markdownSearchAll: 'All',
    markdownSearchMatchCase: 'Match case',
    markdownSearchRegexp: 'Regex',
    markdownSearchByWord: 'Whole word',
    markdownSearchReplaceOne: 'Replace',
    markdownSearchReplaceAll: 'Replace all',
    markdownSearchClose: 'Close',
    markdownSearchCurrentMatch: 'Current match',
    markdownSearchReplacedMatches: 'Replaced $ matches',
    markdownSearchReplacedMatchOnLine: 'Replaced match on line $',
    markdownSearchOnLine: 'on line',
    markdownSearchGoToLine: 'Go to line',
    markdownSearchGo: 'Go',
    ...
    markdownDetailsSummary: 'Details',
    ...
    modelSupportsImageInputBadge: 'Vision',
