...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    switchAgentUnsavedTitle: '有未保存的更改',
    switchAgentUnsavedHint: '切换 Agent 前是否保存当前更改？',
    saveAndSwitch: '保存并切换',
  ...
  en: {
    ...
    switchAgentUnsavedTitle: 'Unsaved Changes',
    switchAgentUnsavedHint: 'Do you want to save your changes before switching Agent?',
