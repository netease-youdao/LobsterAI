...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    agentTabIM: 'IM 渠道',
    agentMcpTab: 'MCP 工具',
    agentMcpSelectorDesc: '选择此 Agent 可使用的 MCP 工具，留空则使用全局启用的所有 MCP。',
    agentMcpInheritGlobal: '未选择 — 将使用全局启用的所有 MCP',
    agentMcpEmpty: '暂无已配置的 MCP 服务器，请先在 MCP 管理中添加。',
    agentMcpSearch: '搜索 MCP 服务器...',
  ...
  en: {
    ...
    agentMcpTab: 'MCP Tools',
    agentMcpSelectorDesc: 'Select MCP tools for this Agent. Leave empty to use all globally enabled MCPs.',
    agentMcpInheritGlobal: 'None selected — all globally enabled MCPs will be used',
    agentMcpEmpty: 'No MCP servers configured. Add one in MCP Manager first.',
    agentMcpSearch: 'Search MCP servers...',
