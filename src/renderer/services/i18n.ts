...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    coworkSearchPlaceholder: '搜索会话标题和内容...',
    coworkSearchNoResults: '未找到相关会话',
    searching: '搜索中...',
    inPageSearchPlaceholder: '在会话中查找',
    inPageSearchNoResults: '无匹配',
    inPageSearchPrev: '上一个',
    inPageSearchNext: '下一个',
    coworkSearchMatchedContent: '匹配内容',
    projects: '项目',
    yourChats: '你的聊天',
    createProject: '新项目',
  ...
  en: {
    ...
    coworkSearchPlaceholder: 'Search by title or content...',
    coworkSearchNoResults: 'No matching conversations found',
    searching: 'Searching...',
    inPageSearchPlaceholder: 'Find in conversation',
    inPageSearchNoResults: 'No results',
    inPageSearchPrev: 'Previous match',
    inPageSearchNext: 'Next match',
    coworkSearchMatchedContent: 'Matched content',
    projects: 'Projects',
