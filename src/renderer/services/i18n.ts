...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    coworkShareSelectMessages: '选择要分享的消息',
    coworkShareSelectAll: '全选',
    coworkShareDeselectAll: '取消全选',
    coworkShareExport: '分享图片',
    coworkShareCancel: '取消',
    coworkShareNoSelection: '请至少选择一条消息',
    coworkSharePreviewTitle: '分享图片预览',
    coworkShareCopyImage: '复制图片',
    coworkShareDownloadImage: '下载图片',
    coworkShareCopyImageSuccess: '图片已复制到剪贴板',
    coworkShareCopyImageFailed: '复制图片失败',
    deleteSession: '删除任务',
    turnIndex: '对话索引',
  ...
  en: {
    ...
    coworkShareSelectMessages: 'Select messages to share',
    coworkShareSelectAll: 'Select All',
    coworkShareDeselectAll: 'Deselect All',
    coworkShareExport: 'Export Image',
    coworkShareCancel: 'Cancel',
    coworkShareNoSelection: 'Please select at least one message',
    coworkSharePreviewTitle: 'Share Image Preview',
    coworkShareCopyImage: 'Copy Image',
    coworkShareDownloadImage: 'Download Image',
    coworkShareCopyImageSuccess: 'Image copied to clipboard',
    coworkShareCopyImageFailed: 'Failed to copy image',
