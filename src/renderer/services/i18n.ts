...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    lmstudioModelNamePlaceholder: 'qwen2.5-coder-7b',
    lmstudioDisplayName: '显示名称（可选）',
    lmstudioDisplayNameHint: '自定义在列表中显示的名称，留空则使用模型名称',
    lmstudioDisplayNamePlaceholder: '我的 LM Studio 模型',
  ...
  en: {
    ...
    lmstudioDisplayNameHint: 'Custom name shown in the model list. Leave empty to use the model name.',
    lmstudioDisplayNamePlaceholder: 'My LM Studio Model',
