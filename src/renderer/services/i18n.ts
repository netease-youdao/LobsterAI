...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    deleteProviderConfirm: '确定要删除此自定义提供商吗？其所有配置和模型将被移除。',
    providerDisplayName: '提供商名称',
    providerDisplayNamePlaceholder: '输入自定义名称（如：公司内部网关）',
    addModel: '添加模型',
    editModel: '编辑模型',
    addNewModel: '添加新模型',
    modelName: '模型名称',
  ...
  en: {
    ...
    deleteProviderConfirm: 'Are you sure you want to delete this custom provider? All its configuration and models will be removed.',
    providerDisplayName: 'Provider Name',
    providerDisplayNamePlaceholder: 'Enter a custom name (e.g., Company Gateway)',
    addModel: 'Add Model',
