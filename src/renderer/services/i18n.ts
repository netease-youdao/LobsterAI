...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    scheduledTasksToggleWarningExpired: '该任务已过期，启用后将不会运行',
            scheduledTasksExport: '导出任务',
            scheduledTasksImportExport: '导入/导出',
    scheduledTasksImport: '导入',
    scheduledTasksImportTasks: '导入任务...',
    scheduledTasksSelectAll: '全选',
    scheduledTasksNSelected: '已选 {n} 项',
    scheduledTasksExportSuccess: '成功导出 {n} 个任务',
    scheduledTasksImportSuccess: '成功导入 {n} 个任务',
    scheduledTasksImportPartial: '导入完成：{success} 成功，{fail} 失败',
    scheduledTasksImportError: '导入失败',
    scheduledTasksImportInvalidFile: '无效的文件格式',
    scheduledTasksImportUnsupportedVersion: '不支持的文件格式版本',
    scheduledTasksCancel: '取消',
    scheduledTasksImportPreviewTitle: '导入任务',
  ...
  en: {
    ...
    scheduledTasksToggleWarningExpired: 'This task has expired. It will not run after enabling',
            scheduledTasksExport: 'Export Tasks',
            scheduledTasksImportExport: 'Import / Export',
    scheduledTasksImport: 'Import',
    scheduledTasksImportTasks: 'Import Tasks...',
    scheduledTasksSelectAll: 'Select All',
    scheduledTasksNSelected: '{n} selected',
    scheduledTasksExportSuccess: 'Exported {n} tasks successfully',
    scheduledTasksImportSuccess: 'Imported {n} tasks successfully',
    scheduledTasksImportPartial: 'Import complete: {success} succeeded, {fail} failed',
    scheduledTasksImportError: 'Import failed',
    scheduledTasksImportInvalidFile: 'Invalid file format',
    scheduledTasksImportUnsupportedVersion: 'Unsupported file format version',
    scheduledTasksCancel: 'Cancel',
    scheduledTasksImportPreviewTitle: 'Import Tasks',
