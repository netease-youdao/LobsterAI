...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    coworkUnpinSession: '取消置顶',
     ...
     coworkSessionManageTags: '管理标签',
     coworkSessionTagPlaceholder: '输入标签名',
     coworkSessionTagSuggestions: '已有标签',
     coworkTagFilterAll: '全部',
  ...
  en: {
    ...
    coworkUnpinSession: 'Unpin task',
     ...
     coworkSessionManageTags: 'Manage tags',
     coworkSessionTagPlaceholder: 'Enter tag name',
     coworkSessionTagSuggestions: 'Existing tags',
     coworkTagFilterAll: 'All',
