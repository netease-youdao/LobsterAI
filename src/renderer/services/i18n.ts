...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    imInstanceNameDuplicate: '实例名称“{name}”已存在，请使用不同的名称',
    imInstanceAppIdDuplicate: '该 App ID 已被其他实例（{name}）使用，请勿重复添加',
    imInstanceClientIdDuplicate: '该 Client ID 已被其他实例（{name}）使用，请勿重复添加',
    imDingTalkNoInstances: '尚未添加钉钉实例，点击下方按钮添加',
    imDingTalkSelectInstance: '请在左侧选择一个钉钉实例',
    imFeishuNoInstances: '尚未添加飞书实例，点击下方按钮添加',
    imFeishuSelectInstance: '请在左侧选择一个飞书实例',
    imQQNoInstances: '尚未添加 QQ 实例，点击下方按钮添加',
    imQQSelectInstance: '请在左侧选择一个 QQ 实例',
  ...
  en: {
    ...
    imInstanceNameDuplicate: 'Instance name "{name}" already exists. Please use a different name.',
    imInstanceAppIdDuplicate: 'This App ID is already used by another instance ({name}). Duplicate not allowed.',
    imInstanceClientIdDuplicate: 'This Client ID is already used by another instance ({name}). Duplicate not allowed.',
    imDingTalkNoInstances: 'No DingTalk instances yet. Click below to add one.',
    imDingTalkSelectInstance: 'Select a DingTalk instance from the sidebar.',
    imFeishuNoInstances: 'No Feishu instances yet. Click below to add one.',
    imFeishuSelectInstance: 'Select a Feishu instance from the sidebar.',
    imQQNoInstances: 'No QQ instances yet. Click below to add one.',
    imQQSelectInstance: 'Select a QQ instance from the sidebar.',
