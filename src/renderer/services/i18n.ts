...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    securitySkillBehaviorNotice: '{name} 技能的以下行为请悉知：',
    ...
    securityScan: '安全扫描',
    securityScanNow: '立即扫描',
    securityScanning: '扫描中...',
    securityLastScan: '上次扫描',
    securityNeverScanned: '从未扫描',
    securityOverallRisk: '整体风险',
    securityRiskSecure: '安全',
    securityRiskLow: '低风险',
    securityRiskMedium: '中风险',
    securityRiskHigh: '高风险',
    securityRiskCritical: '严重风险',
    securityPermissions: '权限管理',
    securityPermissionsDesc: '控制 LobsterAI 可以访问的系统资源',
    securitySkillsSummary: '技能安全',
    securitySkillsHighRisk: '高风险技能',
    securitySkillsCritical: '严重风险技能',
    securityIssues: '安全问题',
    securityIssuesFound: '发现 {count} 个问题',
    securityNoIssues: '未发现安全问题',
    securityViewDetails: '查看详情',
    securityDisableSkill: '禁用',
    securityEnableSkill: '启用',
    securityUninstallSkill: '卸载',
    securityUninstallConfirm: '确定要卸载技能 "{name}" 吗？此操作不可撤销。',
    securityNoRiskySkills: '所有技能均安全',
    securityStatusSecure: '安全',
    securityStatusLowNotice: '少量提醒',
    securityStatusMediumNotice: '一般提醒',
    securityStatusHighNotice: '多项提醒',
    securityStatusCriticalNotice: '需要关注',
    securitySkillBehaviorNoticeHeader: '以下技能包含一些需要您了解的行为，这是正常的功能说明，并非安全警告。',
    securitySkillsWithNotices: '{count} 个技能有行为说明',
    securityClickToReview: '点击查看技能的具体行为',
    securityNoticeCount: '{count} 项行为说明',
    securitySkillBehaviorTitle: '技能行为说明',
    securitySkillsWithDataLeakRisk: '{count} 个技能可能访问敏感数据',
    securityClickToReviewDataLeak: '点击查看具体访问内容',
    securityDataLeakNotice: '{count} 项数据访问提示',
    securityNoDataLeakRisk: '无数据泄露风险',
    securityAutoScan: '自动扫描',
    securityAutoScanStartup: '启动时扫描',
    securityAutoScanSkillInstall: '安装技能时扫描',
    securityNotifications: '通知',
    securityNotifyHighRisk: '高风险告警',
    securityNotifyNewIssue: '新问题通知',
    securityPermFileRead: '文件读取',
    securityPermFileReadDesc: '允许读取本地文件系统中的文件',
    securityPermFileWrite: '文件写入',
    securityPermFileWriteDesc: '允许创建和修改本地文件',
    securityPermShell: '命令执行',
    securityPermShellDesc: '允许执行系统命令和脚本',
    securityPermNetwork: '网络访问',
    securityPermNetworkDesc: '允许发送网络请求',
    securityPermClipboard: '剪贴板访问',
    securityPermClipboardDesc: '允许读取和写入系统剪贴板',
    securityPermScreen: '屏幕捕获',
    securityPermScreenDesc: '允许截取屏幕内容',
    securityPermCalendar: '日历访问',
    securityPermCalendarDesc: '允许访问系统日历事件',
    securityPermBrowser: '浏览器控制',
    securityPermBrowserDesc: '允许控制浏览器打开网页',
    securityPermProcess: '进程管理',
    securityPermProcessDesc: '允许管理系统进程',
    securityPermSystem: '系统设置',
    securityPermSystemDesc: '允许修改系统配置',
    securityCategoryData: '数据访问',
    securityCategorySystem: '系统控制',
    securityCategoryPrivacy: '隐私相关',
    securityCategoryNetwork: '网络通信',
    securityIssuePermEnabled: '高风险权限已启用',
    securityIssuePermEnabledDesc: '该权限可能带来安全风险',
    securityIssuePermEnabledRec: '如果不需要此功能，建议关闭该权限',
    securityIssueSkillHighRisk: '高风险技能已启用',
    securityIssueSkillHighRiskDesc: '该技能包含潜在的安全风险操作',
    securityIssueSkillHighRiskRec: '建议禁用该技能或仔细审查其代码',
    securityIssueSkillCritical: '技能存在严重安全问题',
    securityIssueSkillCriticalDesc: '该技能包含可能危害系统安全的代码',
    securityIssueSkillCriticalRec: '强烈建议禁用或删除该技能',
    securityIssueSensitiveFile: '敏感文件权限不当',
    securityIssueSensitiveFileDesc: '敏感配置文件可能被其他用户读取',
    securityIssueSensitiveFileRec: '建议修改文件权限为仅所有者可读',
    securityIssueRootPrivilege: '以管理员权限运行',
    securityIssueRootPrivilegeDesc: '应用正在以管理员权限运行，存在安全风险',
    securityIssueRootPrivilegeRec: '建议以普通用户权限运行应用',
  ...
  en: {
    ...
    securitySkillBehaviorNotice: 'Please be aware of the following behaviors in {name}:',
    ...
    securityScanNow: 'Scan Now',
    securityScanning: 'Scanning...',
    securityLastScan: 'Last Scan',
    securityNeverScanned: 'Never Scanned',
    securityOverallRisk: 'Overall Risk',
    securityRiskSecure: 'Secure',
    securityRiskLow: 'Low Risk',
    securityRiskMedium: 'Medium Risk',
    securityRiskHigh: 'High Risk',
    securityRiskCritical: 'Critical Risk',
    securityPermissions: 'Permissions',
    securityPermissionsDesc: 'Control system resources LobsterAI can access',
    securitySkillsSummary: 'Skill Security',
    securitySkillsHighRisk: 'High Risk Skills',
    securitySkillsCritical: 'Critical Risk Skills',
    securityIssues: 'Security Issues',
    securityIssuesFound: '{count} issues found',
    securityNoIssues: 'No security issues found',
    securityViewDetails: 'View Details',
    securityDisableSkill: 'Disable',
    securityEnableSkill: 'Enable',
    securityUninstallSkill: 'Uninstall',
    securityUninstallConfirm: 'Are you sure you want to uninstall skill "{name}"? This action cannot be undone.',
    securityNoRiskySkills: 'All skills are secure',
    securityStatusSecure: 'Secure',
    securityStatusLowNotice: 'Few notices',
    securityStatusMediumNotice: 'Some notices',
    securityStatusHighNotice: 'Multiple notices',
    securityStatusCriticalNotice: 'Needs attention',
    securitySkillBehaviorNoticeHeader: 'The following skills contain behaviors you should be aware of. This is a normal feature description, not a security warning.',
    securitySkillsWithNotices: '{count} skills have behavior notices',
    securityClickToReview: 'Click to review skill behaviors',
    securityNoticeCount: '{count} behavior notices',
    securitySkillBehaviorTitle: 'Skill Behavior Info',
    securitySkillsWithDataLeakRisk: '{count} skills may access sensitive data',
    securityClickToReviewDataLeak: 'Click to review data access details',
    securityDataLeakNotice: '{count} data access notices',
    securityNoDataLeakRisk: 'No data leak risk',
    securityAutoScan: 'Auto Scan',
    securityAutoScanStartup: 'Scan on startup',
    securityAutoScanSkillInstall: 'Scan on skill install',
    securityNotifications: 'Notifications',
    securityNotifyHighRisk: 'High risk alerts',
    securityNotifyNewIssue: 'New issue notifications',
    securityPermFileRead: 'File Read',
    securityPermFileReadDesc: 'Allow reading files from local filesystem',
    securityPermFileWrite: 'File Write',
    securityPermFileWriteDesc: 'Allow creating and modifying local files',
    securityPermShell: 'Shell Execution',
    securityPermShellDesc: 'Allow executing system commands and scripts',
    securityPermNetwork: 'Network Access',
    securityPermNetworkDesc: 'Allow sending network requests',
    securityPermClipboard: 'Clipboard Access',
    securityPermClipboardDesc: 'Allow reading and writing system clipboard',
    securityPermScreen: 'Screen Capture',
    securityPermScreenDesc: 'Allow capturing screen content',
    securityPermCalendar: 'Calendar Access',
    securityPermCalendarDesc: 'Allow accessing system calendar events',
    securityPermBrowser: 'Browser Control',
    securityPermBrowserDesc: 'Allow controlling browser to open web pages',
    securityPermProcess: 'Process Management',
    securityPermProcessDesc: 'Allow managing system processes',
    securityPermSystem: 'System Settings',
    securityPermSystemDesc: 'Allow modifying system configuration',
    securityCategoryData: 'Data Access',
    securityCategorySystem: 'System Control',
    securityCategoryPrivacy: 'Privacy',
    securityCategoryNetwork: 'Network',
    securityIssuePermEnabled: 'High-risk permission enabled',
    securityIssuePermEnabledDesc: 'This permission may pose security risks',
    securityIssuePermEnabledRec: 'Consider disabling if not needed',
    securityIssueSkillHighRisk: 'High-risk skill enabled',
    securityIssueSkillHighRiskDesc: 'This skill contains potentially risky operations',
    securityIssueSkillHighRiskRec: 'Consider disabling or reviewing its code',
    securityIssueSkillCritical: 'Skill has critical security issues',
    securityIssueSkillCriticalDesc: 'This skill contains code that may harm system security',
    securityIssueSkillCriticalRec: 'Strongly recommend disabling or removing this skill',
    securityIssueSensitiveFile: 'Sensitive file permission issue',
    securityIssueSensitiveFileDesc: 'Sensitive config file may be readable by others',
    securityIssueSensitiveFileRec: 'Consider restricting file permissions to owner only',
    securityIssueRootPrivilege: 'Running with admin privileges',
    securityIssueRootPrivilegeDesc: 'Application is running with admin privileges',
    securityIssueRootPrivilegeRec: 'Consider running with normal user privileges',
