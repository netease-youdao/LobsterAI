...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    voiceInputNeedConfig: '首次使用语音输入，请先配置听写快捷键',
    macDictationShortcut: '听写快捷键（macOS）',
    macDictationMic: '按下 🎙',
    macDictationControl: '连按两下 Control 键',
    macDictationFn: '连按两下 🌐',
    macDictationRightCmd: '连按两下右 Command 键',
    macDictationLeftCmd: '连按两下左 Command 键',
    macDictationEitherCmd: '连按两下任一 Command 键',
    macDictationHint: '请确保与 macOS 系统设置 → 键盘 → 听写 中的快捷键一致',
    macDictationViewSettings: '查看系统设置',
  ...
  en: {
    ...
    voiceInputNeedConfig: 'Please configure the dictation shortcut before first use',
    macDictationShortcut: 'Dictation Shortcut (macOS)',
    macDictationMic: 'Press 🎙',
    macDictationControl: 'Press Control Twice',
    macDictationFn: 'Press 🌐 Twice',
    macDictationRightCmd: 'Press Right Command Twice',
    macDictationLeftCmd: 'Press Left Command Twice',
    macDictationEitherCmd: 'Press Either Command Twice',
    macDictationHint: 'Must match the shortcut in macOS System Settings → Keyboard → Dictation',
    macDictationViewSettings: 'View System Settings',
