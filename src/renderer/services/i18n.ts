...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    // SelectionToolbar
    selectionToolbarCopy: '复制',
    selectionToolbarQuote: '引用',
    selectionToolbarExplain: '解释',
    selectionToolbarTranslate: '翻译',
    selectionToolbarAsk: '提问',
    selectionToolbarExplainPrompt: '请解释以下内容：\n\n',
    selectionToolbarTranslatePrompt: '请翻译以下内容：\n\n',
    selectionToolbarAskPrompt: '关于以下内容，我想了解更多：\n\n',
    selectionToolbarSettings: '选中文本工具栏',
    selectionToolbarSettingsDesc: '配置选中文本时显示的操作按钮',
    selectionToolbarActionList: '操作列表',
    selectionToolbarBuiltinBadge: '内置',
    selectionToolbarAddCustom: '添加自定义操作',
    selectionToolbarEditAction: '编辑操作',
    selectionToolbarDeleteAction: '删除',
    selectionToolbarDeleteConfirm: '确定要删除此操作吗？',
    selectionToolbarResetDefault: '恢复默认',
    selectionToolbarResetConfirm: '确定要恢复默认设置吗？所有自定义操作将被删除。',
    selectionToolbarActionName: '名称',
    selectionToolbarActionIcon: '图标',
    selectionToolbarActionPrompt: 'Prompt 模板',
    selectionToolbarPromptPlaceholder: '输入 Prompt 模板，使用 {{SELECTED_CONTENT}} 代表选中文本',
    selectionToolbarPromptRequired: 'Prompt 不能为空',
    selectionToolbarPromptMissingPlaceholder: 'Prompt 必须包含 {{SELECTED_CONTENT}} 占位符',
    selectionToolbarNameRequired: '名称不能为空',
    selectionToolbarSave: '保存',
    selectionToolbarCancel: '取消',
    selectionToolbarMoveUp: '上移',
    selectionToolbarMoveDown: '下移',
    selectionToolbarTemplateSummary: '摘要',
    selectionToolbarTemplatePolish: '改写润色',
    selectionToolbarTemplateCodeExplain: '代码解读',
    selectionToolbarTemplateBlank: '空白模板',
    selectionToolbarTemplateSummaryPrompt: '请为以下内容生成简洁的摘要：\n\n{{SELECTED_CONTENT}}',
    selectionToolbarTemplatePolishPrompt: '请改写润色以下内容，使其更加通顺专业：\n\n{{SELECTED_CONTENT}}',
    selectionToolbarTemplateCodeExplainPrompt: '请逐行解释以下代码的作用：\n\n```\n{{SELECTED_CONTENT}}\n```',
    selectionToolbarTemplateBlankPrompt: '{{SELECTED_CONTENT}}',
    selectionToolbarSelectTemplate: '选择模板',
  },
  en: {
    // Common
    save: 'Save',
    ...
    // SelectionToolbar
    selectionToolbarCopy: 'Copy',
    selectionToolbarQuote: 'Quote',
    selectionToolbarExplain: 'Explain',
    selectionToolbarTranslate: 'Translate',
    selectionToolbarAsk: 'Ask',
    selectionToolbarExplainPrompt: 'Please explain the following:\n\n',
    selectionToolbarTranslatePrompt: 'Please translate the following:\n\n',
    selectionToolbarAskPrompt: 'I want to know more about the following:\n\n',
    selectionToolbarSettings: 'Selection Toolbar',
    selectionToolbarSettingsDesc: 'Configure action buttons shown when text is selected',
    selectionToolbarActionList: 'Actions',
    selectionToolbarBuiltinBadge: 'Built-in',
    selectionToolbarAddCustom: 'Add Custom Action',
    selectionToolbarEditAction: 'Edit Action',
    selectionToolbarDeleteAction: 'Delete',
    selectionToolbarDeleteConfirm: 'Are you sure you want to delete this action?',
    selectionToolbarResetDefault: 'Reset to Defaults',
    selectionToolbarResetConfirm: 'Are you sure you want to reset to defaults? All custom actions will be removed.',
    selectionToolbarActionName: 'Name',
    selectionToolbarActionIcon: 'Icon',
    selectionToolbarActionPrompt: 'Prompt Template',
    selectionToolbarPromptPlaceholder: 'Enter prompt template, use {{SELECTED_CONTENT}} for selected text',
    selectionToolbarPromptRequired: 'Prompt cannot be empty',
    selectionToolbarPromptMissingPlaceholder: 'Prompt must include {{SELECTED_CONTENT}} placeholder',
    selectionToolbarNameRequired: 'Name cannot be empty',
    selectionToolbarSave: 'Save',
    selectionToolbarCancel: 'Cancel',
    selectionToolbarMoveUp: 'Move Up',
    selectionToolbarMoveDown: 'Move Down',
    selectionToolbarTemplateSummary: 'Summary',
    selectionToolbarTemplatePolish: 'Rewrite & Polish',
    selectionToolbarTemplateCodeExplain: 'Code Explanation',
    selectionToolbarTemplateBlank: 'Blank Template',
    selectionToolbarTemplateSummaryPrompt: 'Please generate a concise summary of the following:\n\n{{SELECTED_CONTENT}}',
    selectionToolbarTemplatePolishPrompt: 'Please rewrite and polish the following to make it more fluent and professional:\n\n{{SELECTED_CONTENT}}',
    selectionToolbarTemplateCodeExplainPrompt: 'Please explain the following code line by line:\n\n```\n{{SELECTED_CONTENT}}\n```',
    selectionToolbarTemplateBlankPrompt: '{{SELECTED_CONTENT}}',
    selectionToolbarSelectTemplate: 'Select Template',
  }
};
