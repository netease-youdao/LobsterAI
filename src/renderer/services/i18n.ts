...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    modelContextWindowHint: '可选。留空时使用提供商默认值。',
    modelContextWindowInvalid: '上下文窗口必须是大于 0 的整数',
    modelContextWindowBadge: '上下文',
    modelMaxTokens: '输出 Token 上限',
    modelMaxTokensHint: '可选。留空时使用提供商默认值。',
    modelMaxTokensInvalid: '输出 Token 上限必须是大于 0 的整数',
    modelMaxTokensBadge: '输出',
    imageInput: '图像',
  ...
  en: {
    ...
    modelContextWindowHint: 'Optional. Leave blank to use the provider default.',
    modelContextWindowInvalid: 'Context window must be a positive integer',
    modelContextWindowBadge: 'Ctx',
    modelMaxTokens: 'Max output tokens',
    modelMaxTokensHint: 'Optional. Leave blank to use the provider default.',
    modelMaxTokensInvalid: 'Max output tokens must be a positive integer',
    modelMaxTokensBadge: 'Out',
    imageInput: 'Image',
