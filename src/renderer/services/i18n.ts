...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    coworkMemoryExportMarkdown: '导出为 Markdown',
    coworkMemoryExportImage: '导出为图片',
    coworkMemoryImport: '导入记忆',
    coworkMemoryExportEmpty: '没有可导出的记忆条目',
    coworkMemoryExportFailed: '导出记忆失败',
    coworkMemoryExportImageFailed: '导出图片失败',
    coworkMemoryImportFailed: '导入记忆失败',
    coworkMemoryImportSuccess: '成功导入 {count} 条记忆',
    coworkMemoryImportDuplicate: '跳过 {count} 条重复记忆',
    coworkMemoryImportInvalidFile: '无效的记忆文件格式',
    coworkMemoryImportModeTitle: '选择导入方式',
    coworkMemoryImportModeWhole: '整体导入',
    coworkMemoryImportModeWholeHint: '将文件全部内容作为一条记忆',
    coworkMemoryImportModeSplit: '按行拆分导入',
    coworkMemoryImportModeSplitHint: '将每个列表项拆分为独立的记忆条目',
  ...
  en: {
    ...
    coworkMemoryExportMarkdown: 'Export as Markdown',
    coworkMemoryExportImage: 'Export as Image',
    coworkMemoryImport: 'Import memories',
    coworkMemoryExportEmpty: 'No memory entries to export',
    coworkMemoryExportFailed: 'Failed to export memories',
    coworkMemoryExportImageFailed: 'Failed to export image',
    coworkMemoryImportFailed: 'Failed to import memories',
    coworkMemoryImportSuccess: 'Successfully imported {count} memories',
    coworkMemoryImportDuplicate: 'Skipped {count} duplicate memories',
    coworkMemoryImportInvalidFile: 'Invalid memory file format',
    coworkMemoryImportModeTitle: 'Choose import mode',
    coworkMemoryImportModeWhole: 'Import as one entry',
    coworkMemoryImportModeWholeHint: 'Import the entire file content as a single memory',
    coworkMemoryImportModeSplit: 'Split into entries',
    coworkMemoryImportModeSplitHint: 'Split each list item into an individual memory entry',
