...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    teamTemplateSectionTitle: '团队配置模板',
    ...
    teamTemplateConfirmApply: '选择要应用的条目：',
    teamTemplateApplyOptUi: '界面（主题、语言、代理、快捷键）',
    teamTemplateApplyOptModel: '默认模型',
    teamTemplateApplyOptProviders: '各提供商的模型列表、开关与地址（保留本机密钥）',
    teamTemplateApplyOptCowork: '协作引擎、执行模式与记忆相关',
    teamTemplateApplyOptSkills: '技能开关',
    teamTemplateApplyOptWorkdir: '任务文件夹路径',
    teamTemplateApply: '应用模板',
    teamTemplateApplying: '应用中…',
    teamTemplateExportSuccess: '团队模板已导出',
    teamTemplateExportFailed: '导出团队模板失败',
    teamTemplatePendingHint: '已加载模板，请勾选要应用的条目后点击「应用模板」。',
    teamTemplateApplySuccess: '团队模板已应用。不含密钥；请在「模型」页配置 API Key。',
    teamTemplateImportReadFailed: '读取模板文件失败',
    teamTemplateParseErrorInvalidJson: '文件不是有效的 JSON',
    teamTemplateParseErrorInvalidShape: '文件格式无效',
    teamTemplateParseErrorWrongType: '不是 LobsterAI 团队模板文件',
    teamTemplateParseErrorUnsupportedVersion: '模板版本不受支持，请升级应用后重试',
    teamTemplateApplyErrorCowork: '协作设置未能保存',
    teamTemplateApplyErrorGeneric: '应用模板失败',
    testMode: '测试模式',
    theme: '主题',
    appearance: '外观',
    language: '语言',
  ...
  en: {
    ...
    teamTemplateSectionTitle: 'Team config template',
    teamTemplateSectionHint:
    ...
    teamTemplateConfirmApply: 'Choose what to apply:',
    teamTemplateApplyOptUi: 'UI (theme, language, proxy, shortcuts)',
    teamTemplateApplyOptModel: 'Default model',
    teamTemplateApplyOptProviders: 'Per-provider model lists, toggles, and base URLs (keeps local API keys)',
    teamTemplateApplyOptCowork: 'Cowork engine, execution mode, and memory options',
    teamTemplateApplyOptSkills: 'Skill enable/disable',
    teamTemplateApplyOptWorkdir: 'Task folder path',
    teamTemplateApply: 'Apply template',
    teamTemplateApplying: 'Applying…',
    teamTemplateExportSuccess: 'Team template exported',
    teamTemplateExportFailed: 'Failed to export team template',
    teamTemplatePendingHint: 'Template loaded. Choose sections to apply, then click Apply.',
    teamTemplateApplySuccess: 'Team template applied. No secrets included; configure API keys on the Model tab.',
    teamTemplateImportReadFailed: 'Failed to read template file',
    teamTemplateParseErrorInvalidJson: 'File is not valid JSON',
    teamTemplateParseErrorInvalidShape: 'Invalid file structure',
    teamTemplateParseErrorWrongType: 'Not a LobsterAI team template file',
    teamTemplateParseErrorUnsupportedVersion: 'Unsupported template version; try updating the app',
    teamTemplateApplyErrorCowork: 'Could not save cowork settings',
    teamTemplateApplyErrorGeneric: 'Failed to apply template',
    testMode: 'Test Mode',
    theme: 'Theme',
