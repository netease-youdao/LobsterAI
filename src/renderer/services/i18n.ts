...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    coworkErrorEventIdleTimeout: 'AI 模型长时间无响应，会话已自动终止。请检查模型服务状态后重试。',
  ...
  en: {
    ...
    coworkErrorEventIdleTimeout: 'The AI model stopped responding. The session has been automatically terminated. Please check the model service status and try again.',
