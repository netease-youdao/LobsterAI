...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    coworkDockerSandboxTitle: 'Docker（沙箱运行时）',
    coworkDockerSandboxChecking: '正在检测 Docker…',
    coworkDockerSandboxOk: 'Docker 已就绪',
    coworkDockerSandboxCliMissing: '未在 PATH 中找到 docker 命令。请安装 Docker Desktop 并确保终端可执行 docker。',
    coworkDockerSandboxDaemonDown: '已安装 Docker，但无法连接守护进程。请启动 Docker Desktop。',
    coworkDockerSandboxTimeout: '检测 Docker 超时，请确认 Docker Desktop 正在运行后重试。',
    coworkDockerSandboxError: '检测 Docker 时出错。',
    coworkDockerSandboxRefresh: '重新检测',
    coworkDockerSandboxDocs: '安装与启动说明',
    coworkDockerSandboxHintWhenUnavailable: '若使用 OpenClaw 沙箱或部分 IM 频道会话，需要本机 Docker 可用；未使用时可忽略。',
  ...
  en: {
    ...
    coworkDockerSandboxTitle: 'Docker (sandbox runtime)',
    coworkDockerSandboxChecking: 'Checking Docker…',
    coworkDockerSandboxOk: 'Docker is ready',
    coworkDockerSandboxCliMissing: 'The docker command was not found in PATH. Install Docker Desktop and ensure docker is available.',
    coworkDockerSandboxDaemonDown: 'Docker is installed but the daemon is not reachable. Start Docker Desktop.',
    coworkDockerSandboxTimeout: 'Docker check timed out. Make sure Docker Desktop is running, then retry.',
    coworkDockerSandboxError: 'An error occurred while checking Docker.',
    coworkDockerSandboxRefresh: 'Check again',
    coworkDockerSandboxDocs: 'Install and setup',
    coworkDockerSandboxHintWhenUnavailable: 'Sandboxed runs (OpenClaw sandbox or some IM channel sessions) need Docker on this machine; you can ignore this if you do not use them.',
    coworkAgentEngineClaudeLegacy: 'Cowork',
