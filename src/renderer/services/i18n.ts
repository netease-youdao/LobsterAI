...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    zhipuCodingPlanHint: '启用后使用 GLM Coding Plan 专属 API 端点（OpenAI 兼容格式）',
    zhipuCodingPlanEndpointHint: '使用 GLM Coding Plan 时，需要配置专属的 Coding API 端点',
  ...
  en: {
    ...
    zhipuCodingPlanHint: 'When enabled, uses the GLM Coding Plan dedicated API endpoint (OpenAI-compatible format)',
    zhipuCodingPlanEndpointHint: 'When using GLM Coding Plan, you need to configure the dedicated Coding API endpoint',
