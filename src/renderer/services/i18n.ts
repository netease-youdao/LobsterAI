...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    favorites: '收藏夹',
    favoritesEmpty: '暂无收藏',
    favoritesEmptyHint: '在对话中点击收藏按钮，将重要内容保存到这里',
    addToFavorites: '收藏',
    removeFromFavorites: '取消收藏',
    favoriteAdded: '已收藏',
    favoriteRemoved: '已取消收藏',
    favoritesDeleteConfirmTitle: '确认删除收藏',
    favoritesDeleteConfirmMessage: '此操作无法撤销，该收藏将被永久删除。',
    favoriteGoToSession: '跳转到对话',
    batchFavorite: '批量收藏',
    batchFavoriteSelected: '已选 {count} 条',
    batchFavoriteDone: '收藏',
    batchFavoriteExit: '退出批量收藏',
    batchFavoriteSuccess: '已成功收藏 {count} 条消息',
    authZeroCredits: '0积分',
    planFree: '免费',
    planStandard: '标准',
    planAdvanced: '进阶',
  ...
  en: {
    ...
    favoritesEmptyHint: 'Tap the bookmark icon in conversations to save important messages here',
    addToFavorites: 'Add to Favorites',
    removeFromFavorites: 'Remove from Favorites',
    favoriteAdded: 'Added to Favorites',
    favoriteRemoved: 'Removed from Favorites',
    favoritesDeleteConfirmTitle: 'Confirm Deletion',
    favoritesDeleteConfirmMessage: 'This action cannot be undone. The favorite will be permanently deleted.',
    favoriteGoToSession: 'Go to conversation',
    batchFavorite: 'Batch Favorite',
    batchFavoriteSelected: '{count} selected',
    batchFavoriteDone: 'Favorite',
    batchFavoriteExit: 'Exit batch mode',
    batchFavoriteSuccess: 'Successfully favorited {count} messages',
