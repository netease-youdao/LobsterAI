...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ownershipSync_failed: '已关联，同步失败，请重试',
    ownershipRetrySync: '重试同步',
    ownershipRetryScheduled: '已请求重新同步，账号归属保持不变。',
    ownershipAssociate: "关联账号",
    ownershipDetails: "归属与同步详情",
    ownershipTaskDetails: "任务详情",
    ownershipAgentDetails: "Agent 详情",
    ownershipTaskOwner: "任务归属",
    ownershipAgentOwner: "Agent 归属",
    ownershipAgent: "所属 Agent",
    ownershipAnonymous: "未关联账号 · 本机可见",
    ownershipAnonymousSummary: "未关联账号 · 仅本机",
    ownershipUpdatedSummary: "{time} 更新",
    ownershipCompactSync_local: "仅本机",
    ownershipCompactSync_pending: "待同步",
    ownershipCompactSync_synced: "已同步",
    ownershipCompactSync_waiting_service: "同步服务暂不可用",
    ownershipCompactSync_failed: "同步失败",
    ownershipDefault: "默认公共入口",
    ownershipCurrentAccount: "当前账号",
    ownershipComputer: "所在电脑",
    ownershipTaskStatus: "执行状态",
    ownershipUpdatedAt: "更新时间",
    ownershipAssociatedAt: "关联时间",
    ownershipMobileSync: "手机同步",
    ownershipSync_local: "仅保存在本机",
    ownershipSync_pending: "已关联，等待同步；手机暂未完整可见",
    ownershipSync_synced: "已同步",
    ownershipSync_waiting_service: "已关联，同步服务暂不可用",
    ownershipVisibleTasks: "可见任务",
    ownershipLatestTask: "最近任务",
    ownershipStatus_idle: "未开始",
    ownershipStatus_running: "执行中",
    ownershipStatus_completed: "已完成",
    ownershipStatus_error: "执行失败",
    ownershipStatus_stopped: "已停止",
    ownershipStatus_waiting_approval: "等待审批",
    ownershipStatus_cancelled: "已取消",
    ownershipSuccess: "已关联账号",
    ownershipAssociationSyncFailed: "已关联，同步失败",
    ownershipCommitting: "正在保存账号归属…",
    ownershipConfirmAccount: "将关联到：",
    ownershipAssociationDetails: "关联详情",
    ownershipAgentTaskCount: "同时关联 {count} 个任务",
    ownershipAgentOnly: "仅关联此 Agent",
    ownershipTaskCount: "本次关联 {count} 个任务",
    ownershipIncludedSubtasks: "含 {count} 个子任务",
    ownershipIncludedTasks: "包含的任务",
    ownershipAdditionalTasks: "同时关联的任务",
    ownershipRetainedTasks: "{count} 个已关联任务保持原归属。",
    ownershipForksExcluded: "普通分支任务不会一起关联。",
    ownershipSubtask: "子任务",
    ownershipConfirmVisibility: "关联后，仅此账号在当前空间内可见；退出登录或切换账号、空间后隐藏。",
    ownershipAgentLocalFiles: "保留原 Agent、任务 ID、工作目录和创建时间。文件与记忆保留在本机，不会随本次关联上传；应用内归属不隔离操作系统文件访问。",
    ownershipTaskAgentUnchanged: "所属 Agent 的归属不变。共享 Agent 的配置与记忆仍按现有规则在本机使用。",
    ownershipNoAutomaticRemote: "本次不会自动开启手机连接。联网并允许手机连接后，同步任务历史；同步不会重新执行任务。",
    ownershipUnknown: "提交结果尚未确认。请先核对结果，避免重复关联。关闭窗口不会丢失待核对记录。",
    ownershipCheckResult: "核对结果",
    ownershipLogin: "去登录",
    ownershipConfirm: "确认关联",
    ownershipRecheck: "重新检查",
    ownershipError_AUTH_REQUIRED: "请先登录。登录成功后会重新检查关联范围，仍需您确认。",
    ownershipError_ACCOUNT_CHANGED: "账号或空间已改变，请重新打开详情并确认。",
    ownershipError_PLAN_EXPIRED: "确认信息已过期，请重新检查关联范围。",
    ownershipError_PLAN_CHANGED: "关联范围已改变，或上次提交已确认未完成。请重新检查后确认。",
    ownershipError_RESOURCE_BUSY: "存在执行中、等待审批或结果尚未确认的操作。请待操作结束后重新检查。",
    ownershipError_NOT_ASSOCIABLE: "当前内容无法整体关联，可能存在其他归属或不一致的任务关系。未修改任何归属。",
    ownershipError_NOT_AVAILABLE: "当前内容不可用或暂时无法读取，请重新打开详情。",
    ownershipError_REQUEST_CONFLICT: "关联请求与已保存的确认不一致，请核对当前归属后重新检查。",
    ownershipError_LOCAL_COMMIT_FAILED: "本地保存失败，未完成关联。请检查磁盘空间后重新检查。",
    accountSessionChanged: '账号已切换，请重试。',
    remoteTitle: '手机控制电脑',
    remoteDeviceManagement: '设备管理',
    remoteConnectedSummary: '已连接',
    remoteOtherConnectedComputers: '其他已连接电脑',
    remoteSyncPaused: '同步暂停',
    remoteHistoryAdmissionDeferred: '历史同步数据较多，已暂停自动整理；电脑端可继续使用。',
    remoteTasksSyncFailed: '部分任务同步异常',
    remoteTasksSyncFailedCount: '{count} 个任务同步异常',
    remoteTaskSyncDetails: '查看异常任务',
    remoteTaskSyncLocalUnaffected: '其他任务继续同步，电脑端可正常使用。',
    remoteTaskSyncRetrying: '同步暂时失败，将自动重试',
    remoteTaskSyncIsolated: '同步已暂停，电脑端可继续使用',
    remoteTaskSyncWaiting: '等待同步条件恢复',
    remoteTaskSyncRepairing: '正在修复同步',
    remoteTaskSyncClosed: '远程同步已关闭',
    remoteUnnamedTask: '未命名任务',
    remoteRetryTask: '重试此任务',
    remoteTaskRetryRequested: '已安排核对该任务的同步状态。',
    remoteTaskNextRetry: '下次自动重试：{time}',
    remoteTaskIssuesTruncated: '当前展示前 20 个异常任务，恢复后将展示后续任务。',
    remoteContentSyncing: '同步中',
    remoteSyncRecovering: '同步恢复中',
    remoteFilesPending: '部分文件待同步',
    remoteQuotaAttention: '连接数已满，同步暂停',
    remoteRemovedAttention: '连接已移除，同步暂停',
    remoteConnectionAttention: '手机连接暂不可用',
    settingsUnsavedTitle: '保存设置修改？',
    settingsUnsavedDescription: '其他设置还有未保存的修改。已完成的设备操作不受影响。',
    settingsContinueEditing: '继续编辑',
    settingsDiscardDraft: '放弃修改',
    settingsSaveDraft: '保存并关闭',
    remoteRemovedCompactHelp: '此电脑已暂停手机连接，本地任务照常运行。',
    remoteQrOfficialSiteCompact: '扫码访问官网',
    remoteDeviceHelpLabel: '设备管理说明',
    remoteDeviceHelpConnections: '连接名额',
    remoteDeviceHelpConnectionsFallback: '连接名额按同一账号、同一空间计算。',
    remoteDeviceHelpSlotDetails: '手机不占电脑名额；短暂断线会暂时保留名额。',
    remoteDeviceHelpRemoval: '移除与恢复',
    remoteDeviceHelpSync: '会话同步',
    remoteDeviceHelpSwitches: '手机连接与保持唤醒开关位于左下角的手机控制电脑入口。',
    remoteQuotaSlotAvailable: '连接名额已释放，正在尝试连接；连接后将恢复同步。',
    remoteConnectionInstance: '实例 {id}',
    remoteDevicesBannerTitle: '手机连接电脑，随时继续任务',
    remoteDevicesBannerBenefits: '查看进度 · 继续对话 · 查看文件',
    remoteWaitingForConnection: '等待连接',
    remoteConnectionRemoved: '已移除',
    remoteQuotaPaused: '已连接 {limit} 台电脑，当前电脑同步已暂停。',
    remoteQuotaPausedWithoutCount: '连接名额已满，当前电脑同步已暂停。',
    remoteLocalTasksUnaffected: '本地任务可正常使用。',
    remoteManageConnections: '管理连接',
    remoteRemovedHelp: '此电脑已暂停手机连接。重新连接后恢复同步。',
    remoteEnableConnection: '开启手机连接',
    remoteReconnectSlotRetained: '重连中，暂时保留连接名额。',
    remoteConnectedComputers: '已连接电脑',
    remoteRefreshConnections: '刷新',
    remoteConnectionsIncludeCurrent: '包含当前电脑',
    remoteComputer: '电脑',
    remoteRemovingConnection: '正在移除…',
    remoteConnectionRemovedToast: '已移除',
    remoteConnectionReconnecting: '重连中',
    remoteConnectionUnknown: '连接状态暂不可用',
    remoteNoOtherConnections: '暂无其他已连接电脑',
    remoteConnectionLimitHelp: '同一账号、同一空间最多连接 {limit} 台电脑。',
    remoteConnectionsUnavailable: '暂时无法更新连接状态，本地任务不受影响。',
    remoteConnectionsLastUpdated: '上次更新：{time}',
    remoteConnectionChanged: '设备状态已变化，请刷新后重试。',
    remoteConnectionOperationUnconfirmed: '操作结果待确认，请刷新查询；重试不会重复移除设备。',
    remoteRemoveConnectionLabel: '移除 {name} 的连接',
    remoteRemoveConnection: '移除',
    remoteRemoveConnectionTitle: '移除“{name}”？',
    remoteRemoveConnectionDescription: '将暂停这台电脑的手机连接与同步，本地任务继续运行，已同步历史保留。',
    remoteRemoveConnectionResumeHelp: '需要在这台电脑点击“重新连接”才能恢复。',
    remoteConnectionUpgradeWarning: '该电脑需升级有道龙虾后才能重新连接手机。',
    remoteResumeRequested: '正在尝试重新连接',
    remoteDeviceManagementDescription: '查看当前电脑的连接状态，重命名设备或重新连接。',
    remoteQrOfficialSite: '扫码访问有道龙虾官网',
    remoteQrDownloadPending: '手机 App 下载入口准备中',
    remoteQrAppDownload: '扫码下载有道龙虾 App',
    remoteQrAppDownloadHint: '手机与电脑登录同一账号，即可连接',
    remoteQrUnavailable: '二维码暂不可用',
    remoteEntryLink: '官网链接',
    remoteEntryDownloadLink: 'App 下载链接',
    remoteCopyLink: '复制链接',
    remoteLinkCopied: '链接已复制',
    remoteOpenLinkFailed: '未能打开链接，请重试。',
    remoteHowItWorks: '使用说明',
    remoteSameIdentityHelp: '手机和电脑需登录同一账号、同一身份空间；同团队其他成员不会自动获得访问权限。',
    remoteHistoryHelp: '仅同步已关联当前账号的会话；历史匿名任务需在任务菜单中主动“关联账号”。',
    remoteAwakeHelp: '应用需要保持运行；锁屏后部分任务仍需在电脑处理。保持唤醒允许熄屏，不保证合盖运行、网络唤醒或自动解锁。',
    remoteSettingsUnconfirmed: '未能确认设置状态，请重试。',
    remoteLoginUnavailable: '当前版本暂不可登录',
    remoteDescription: '在手机上连接这台电脑，继续对话、发起任务，并实时查看执行进度。',
    remoteLoginRequired: '登录后生效',
    remoteOnline: '在线',
    remotePersonalAccount: '个人账号',
    remoteTeamAccount: '团队账号',
    remotePermissionRead: '查看会话',
    remotePermissionControl: '发起和控制任务',
    remoteOffline: '离线',
    remoteHistoryScope: '仅同步创建时已确认属于当前账号的会话；旧版历史不会自动关联。',
    remoteDeviceName: '设备名称',
    remoteWorkspaces: '手机可选择的任务目录',
    remoteAddWorkspace: '添加任务目录',
    remoteAccessRequests: '待授权手机',
    remoteMobileDevice: '手机设备',
    remoteApprovalWarning: '授权后，该手机可以读取会话并在本机发起任务。请核对设备名称。',
    remoteApprove: '允许访问',
    remoteDeny: '拒绝',
    remoteUnavailable: '远程服务暂不可用',
    remoteAgentCatalogSyncFailed: 'Agent 列表同步失败，正在重试',
    remoteSessionSyncFailed: '部分会话同步失败',
    remoteSaveFailed: '未能保存设置，请重试。',

    remoteAllowConnection: '允许手机连接',
    remoteAllowDescription: '允许同一账号的手机查看会话并控制任务。',
    remoteThisComputer: '当前电脑',
    remoteCurrentDevice: '当前设备',
    remoteKeepAwake: '保持电脑唤醒',
    remoteKeepAwakeDescription: '运行时防止电脑自动休眠，允许屏幕关闭。',
    remoteKeepAwakeFailed: '保持唤醒未生效，请重试。',
    remoteKeepAwakeDisableFailed: '保持唤醒未能关闭，电脑可能仍不会自动休眠。',
    remoteLoading: '正在读取设备状态…',
    remoteSignedOut: '登录后可连接',
    remoteDisabled: '已关闭手机连接',
    remoteConnecting: '正在连接…',
    remoteReconnecting: '正在重新连接…',
    remoteServerUpgradeRequired: '远程服务需要升级，请稍后重试',
    remoteDeviceUnavailable: '当前设备暂不可连接，请检查登录状态后重试',
    remoteWorkspaceUnavailable: '新任务的工作目录暂不可用，请在电脑检查后重试',
    remoteDeviceLimit: '在线电脑数量已达上限',
    remoteRegistrationLimit: '已登记电脑数量已达上限',
    remoteLoginExpired: '登录已失效，请重新登录',
    remoteLoginFailed: '未能打开登录页面，请重试。',
    remoteScreenLocked: '屏幕已锁定',
    remoteRenameDevice: '重命名设备',
    remoteRenameHint: '仅修改有道龙虾中的显示名称，最多 100 个字符。',
    remoteNameInvalid: '请输入 1–100 个字符，不能包含换行或控制字符。',
    remoteNameSaved: '设备名称已更新',
    remoteSavedPending: '已保存，联网后同步',
    remoteNamePending: '名称待同步',
    remoteSettingsPending: '设置待同步',
    remoteDisabledPending: '已在本机关闭，联网后同步',
    remoteSettingsSaved: '设置已保存',
    remoteUnsavedChanges: '修改尚未保存，点击下方“保存”后生效。',
    remoteAccountChanged: '账号已切换，请重新检查手机控制电脑设置。',
    remoteConnectionFailed: '连接失败',
    remoteCredentialInvalid: '设备验证失败；若重新连接后仍无法恢复，请联系技术支持。',
    remoteReconnect: '重新连接',
    remoteReconnectFailed: '重新连接失败，请稍后重试。',
    remoteRetryOnSave: '保存时重试',
    remoteStateUnavailable: '暂时无法读取设备状态，请稍后重试。',
    ...
    coworkApprove: '允许',
    coworkApproveOnce: '允许本次',
    coworkApproveAlways: '始终允许',
    coworkApprovalSubmitting: '正在提交，请稍候…',
    coworkApprovalUnknown: '正在核对处理结果，请勿重复操作。',
    coworkApprovalExpired: '该审批已到期，正在更新状态。',
    coworkApprovalNotApplied: '此次操作未生效，请查看最新审批状态。',
    coworkDeny: '拒绝',
    coworkConfirmSelection: '提交当前选择',
    coworkQuestionSubmitFailed: '提交失败，请重试。',
  ...
  en: {
    ownershipSync_failed: 'Associated; sync failed. Please retry.',
    ownershipRetrySync: 'Retry sync',
    ownershipRetryScheduled: 'Sync retry requested. Account ownership is unchanged.',
    ownershipAssociate: "Link account",
    ownershipDetails: "Ownership and sync details",
    ownershipTaskDetails: "Task details",
    ownershipAgentDetails: "Agent details",
    ownershipTaskOwner: "Task owner",
    ownershipAgentOwner: "Agent owner",
    ownershipAgent: "Agent",
    ownershipAnonymous: "Unassociated · visible on this computer",
    ownershipAnonymousSummary: "No account · This computer only",
    ownershipUpdatedSummary: "Updated {time}",
    ownershipCompactSync_local: "This computer only",
    ownershipCompactSync_pending: "Sync pending",
    ownershipCompactSync_synced: "Synced",
    ownershipCompactSync_waiting_service: "Sync service temporarily unavailable",
    ownershipCompactSync_failed: "Sync failed",
    ownershipDefault: "Shared default entry",
    ownershipCurrentAccount: "Current account",
    ownershipComputer: "Computer",
    ownershipTaskStatus: "Task status",
    ownershipUpdatedAt: "Updated",
    ownershipAssociatedAt: "Associated",
    ownershipMobileSync: "Mobile sync",
    ownershipSync_local: "Stored only on this computer",
    ownershipSync_pending: "Associated; waiting to sync. Mobile history may be incomplete.",
    ownershipSync_synced: "Synced",
    ownershipSync_waiting_service: "Associated; sync service temporarily unavailable",
    ownershipVisibleTasks: "Visible tasks",
    ownershipLatestTask: "Latest task",
    ownershipStatus_idle: "Not started",
    ownershipStatus_running: "Running",
    ownershipStatus_completed: "Completed",
    ownershipStatus_error: "Failed",
    ownershipStatus_stopped: "Stopped",
    ownershipStatus_waiting_approval: "Waiting for approval",
    ownershipStatus_cancelled: "Cancelled",
    ownershipSuccess: "Account linked",
    ownershipAssociationSyncFailed: "Account linked; sync failed",
    ownershipCommitting: "Saving account ownership…",
    ownershipConfirmAccount: "Associate with:",
    ownershipAssociationDetails: "Link details",
    ownershipAgentTaskCount: "Also links {count} tasks",
    ownershipAgentOnly: "Links this Agent only",
    ownershipTaskCount: "Links {count} tasks",
    ownershipIncludedSubtasks: "Includes {count} subtasks",
    ownershipIncludedTasks: "Included tasks",
    ownershipAdditionalTasks: "Also included",
    ownershipRetainedTasks: "{count} already-linked tasks keep their current ownership.",
    ownershipForksExcluded: "Independent forks are not included.",
    ownershipSubtask: "Subtask",
    ownershipConfirmVisibility: "Visible only in this account and space after linking. Hidden when you sign out or switch accounts or spaces.",
    ownershipAgentLocalFiles: "Keep the original Agent, task IDs, directories and creation dates. Files and memories stay local and are not uploaded by association; app ownership does not isolate operating-system file access.",
    ownershipTaskAgentUnchanged: "The Agent keeps its current ownership. Shared Agent settings and memories remain available locally under the existing rules.",
    ownershipNoAutomaticRemote: "This does not enable phone connections. History syncs when online and remote access is enabled; tasks will not run again.",
    ownershipUnknown: "The commit result is not yet confirmed. Check it before associating again. Closing this window preserves the pending record.",
    ownershipCheckResult: "Check result",
    ownershipLogin: "Sign in",
    ownershipConfirm: "Confirm link",
    ownershipRecheck: "Check again",
    ownershipError_AUTH_REQUIRED: "Sign in first. We will check the affected items again after sign-in; your confirmation is still required.",
    ownershipError_ACCOUNT_CHANGED: "Your account or space changed. Open details again to review.",
    ownershipError_PLAN_EXPIRED: "The preview expired. Check the affected items again.",
    ownershipError_PLAN_CHANGED: "The affected items changed, or the previous attempt was confirmed not committed. Check again before confirming.",
    ownershipError_RESOURCE_BUSY: "An affected operation is running, awaiting approval or awaiting confirmation. Check again once it finishes.",
    ownershipError_NOT_ASSOCIABLE: "These items cannot be associated together because of ownership or task relationship constraints. No ownership was changed.",
    ownershipError_NOT_AVAILABLE: "These items are unavailable or could not be read. Open details again.",
    ownershipError_REQUEST_CONFLICT: "This request differs from its saved confirmation. Check current ownership and review again.",
    ownershipError_LOCAL_COMMIT_FAILED: "Local saving failed; association did not complete. Check available disk space and try again.",
    accountSessionChanged: 'The account changed. Please try again.',
    remoteTitle: 'Control this computer from your phone',
    remoteDeviceManagement: 'Device management',
    remoteConnectedSummary: 'Connected',
    remoteOtherConnectedComputers: 'Other connected computers',
    remoteSyncPaused: 'Sync paused',
    remoteHistoryAdmissionDeferred: 'Automatic processing of a large sync history is paused. You can continue using this computer.',
    remoteTasksSyncFailed: 'Some tasks have sync issues',
    remoteTasksSyncFailedCount: '{count} tasks have sync issues',
    remoteTaskSyncDetails: 'View affected tasks',
    remoteTaskSyncLocalUnaffected: 'Other tasks continue syncing. You can keep using this computer.',
    remoteTaskSyncRetrying: 'Sync temporarily failed. It will retry automatically.',
    remoteTaskSyncIsolated: 'Sync paused. You can continue on this computer.',
    remoteTaskSyncWaiting: 'Waiting for sync requirements to recover',
    remoteTaskSyncRepairing: 'Repairing sync',
    remoteTaskSyncClosed: 'Remote sync closed',
    remoteUnnamedTask: 'Untitled task',
    remoteRetryTask: 'Retry this task',
    remoteTaskRetryRequested: 'This task is scheduled for a sync status check.',
    remoteTaskNextRetry: 'Next automatic retry: {time}',
    remoteTaskIssuesTruncated: 'Showing the first 20 affected tasks. More will appear as these recover.',
    remoteContentSyncing: 'Syncing',
    remoteSyncRecovering: 'Recovering sync',
    remoteFilesPending: 'Some files pending sync',
    remoteQuotaAttention: 'Connection limit reached; sync paused',
    remoteRemovedAttention: 'Connection removed; sync paused',
    remoteConnectionAttention: 'Mobile connection unavailable',
    settingsUnsavedTitle: 'Save settings changes?',
    settingsUnsavedDescription: 'Other settings have unsaved changes. Completed device actions are unaffected.',
    settingsContinueEditing: 'Keep editing',
    settingsDiscardDraft: 'Discard changes',
    settingsSaveDraft: 'Save and close',
    remoteRemovedCompactHelp: 'Phone access is paused on this computer. Local tasks continue normally.',
    remoteQrOfficialSiteCompact: 'Visit our website',
    remoteDeviceHelpLabel: 'Device management help',
    remoteDeviceHelpConnections: 'Connection slots',
    remoteDeviceHelpConnectionsFallback: 'Computer connection slots are counted within the same account and space.',
    remoteDeviceHelpSlotDetails: 'Phones do not use computer slots. Brief disconnections temporarily retain a slot.',
    remoteDeviceHelpRemoval: 'Remove and reconnect',
    remoteDeviceHelpSync: 'Conversation syncing',
    remoteDeviceHelpSwitches: 'Find phone access and keep-awake switches in the bottom-left Phone control entry.',
    remoteQuotaSlotAvailable: 'A connection slot is available. Trying to connect and resume syncing.',
    remoteConnectionInstance: 'Instance {id}',
    remoteDevicesBannerTitle: 'Connect your phone and continue your tasks',
    remoteDevicesBannerBenefits: 'Follow progress · Continue conversations · View files',
    remoteWaitingForConnection: 'Waiting to connect',
    remoteConnectionRemoved: 'Removed',
    remoteQuotaPaused: '{limit} computers are connected. Sync on this computer is paused.',
    remoteQuotaPausedWithoutCount: 'All connection slots are in use. Sync on this computer is paused.',
    remoteLocalTasksUnaffected: 'Local tasks continue to work normally.',
    remoteManageConnections: 'Manage connections',
    remoteRemovedHelp: 'Phone access is paused on this computer. Reconnect to resume syncing.',
    remoteEnableConnection: 'Enable phone access',
    remoteReconnectSlotRetained: 'Reconnecting. This computer’s connection slot is temporarily reserved.',
    remoteConnectedComputers: 'Connected computers',
    remoteRefreshConnections: 'Refresh',
    remoteConnectionsIncludeCurrent: 'Includes this computer',
    remoteComputer: 'Computer',
    remoteRemovingConnection: 'Removing…',
    remoteConnectionRemovedToast: 'Connection removed.',
    remoteConnectionReconnecting: 'Reconnecting',
    remoteConnectionUnknown: 'Connection status unavailable',
    remoteNoOtherConnections: 'No other computers are connected',
    remoteConnectionLimitHelp: 'Up to {limit} computers can connect within the same account and space.',
    remoteConnectionsUnavailable: 'Unable to update connection status. Local tasks are unaffected.',
    remoteConnectionsLastUpdated: 'Last updated: {time}',
    remoteConnectionChanged: 'The device state has changed. Refresh and try again.',
    remoteConnectionOperationUnconfirmed: 'The result is not yet confirmed. Refresh to check; retrying will not remove the device twice.',
    remoteRemoveConnectionLabel: 'Remove connection to {name}',
    remoteRemoveConnection: 'Remove',
    remoteRemoveConnectionTitle: 'Remove “{name}”?',
    remoteRemoveConnectionDescription: 'Phone access and syncing will pause on this computer. Local tasks continue, and synced history is retained.',
    remoteRemoveConnectionResumeHelp: 'To resume, click Reconnect on that computer.',
    remoteConnectionUpgradeWarning: 'That computer must upgrade LobsterAI before it can reconnect to your phone.',
    remoteResumeRequested: 'Connection access restored. Trying to connect.',
    remoteDeviceManagementDescription: 'View this computer’s connection status, rename it, or reconnect.',
    remoteQrOfficialSite: 'Scan to visit the LobsterAI website',
    remoteQrDownloadPending: 'Mobile app download link coming soon',
    remoteQrAppDownload: 'Scan to download the LobsterAI app',
    remoteQrAppDownloadHint: 'Sign in to the same account on your phone and computer to connect',
    remoteQrUnavailable: 'QR code is temporarily unavailable',
    remoteEntryLink: 'Website link',
    remoteEntryDownloadLink: 'App download link',
    remoteCopyLink: 'Copy link',
    remoteLinkCopied: 'Link copied',
    remoteOpenLinkFailed: 'Could not open the link. Please retry.',
    remoteHowItWorks: 'How it works',
    remoteSameIdentityHelp: 'Sign in to the same account and identity space on your phone and computer. Other team members do not automatically get access.',
    remoteHistoryHelp: 'Only conversations linked to the current account are synced. To include older anonymous tasks, choose “Link account” from the task menu.',
    remoteAwakeHelp: 'Keep the app running. Some tasks still need attention on the computer when the screen is locked. Keep awake allows the display to turn off; it does not guarantee closed-lid operation, network wake, or automatic unlocking.',
    remoteSettingsUnconfirmed: 'Could not confirm the setting. Try again.',
    remoteLoginUnavailable: 'Sign-in is unavailable in this version',
    ...
    remoteOnline: 'Online',
    remotePersonalAccount: 'Personal account',
    remoteTeamAccount: 'Team account',
    remotePermissionRead: 'View conversations',
    remotePermissionControl: 'Start and control tasks',
    remoteOffline: 'Offline',
    remoteHistoryScope: 'Only conversations with a verified owner at creation are synced. Older history is never assigned automatically.',
    remoteDeviceName: 'Device name',
    remoteWorkspaces: 'Task folders available to mobile',
    remoteAddWorkspace: 'Add task folder',
    remoteAccessRequests: 'Mobile access requests',
    remoteMobileDevice: 'Mobile device',
    remoteApprovalWarning: 'This phone will be able to read conversations and start tasks here. Check the device name.',
    remoteApprove: 'Allow access',
    remoteDeny: 'Deny',
    remoteUnavailable: 'Remote service is temporarily unavailable',
    remoteAgentCatalogSyncFailed: 'Agent list sync failed. Retrying.',
    remoteSessionSyncFailed: 'Some conversations failed to sync.',
    remoteSaveFailed: 'Could not save settings. Please retry.',

    remoteAllowConnection: 'Allow phone access',
    remoteAllowDescription: 'Let phones on the same account view conversations and control tasks.',
    remoteThisComputer: 'This computer',
    remoteCurrentDevice: 'Current device',
    remoteKeepAwake: 'Keep this computer awake',
    remoteKeepAwakeDescription: 'Prevent automatic sleep while LobsterAI is running. The display can still turn off.',
    remoteKeepAwakeFailed: 'Keeping awake is not active. Please retry.',
    remoteKeepAwakeDisableFailed: 'Could not turn off Keep awake. This computer may still be prevented from sleeping automatically.',
    remoteLoading: 'Reading device status…',
    remoteSignedOut: 'Sign in to connect',
    remoteDisabled: 'Mobile connections are off',
    remoteConnecting: 'Connecting…',
    remoteReconnecting: 'Reconnecting…',
    remoteServerUpgradeRequired: 'The remote service needs an update. Please try again later.',
    remoteDeviceUnavailable: 'This device cannot connect. Check your sign-in status and retry.',
    remoteWorkspaceUnavailable: 'The folder for new tasks is unavailable. Check it on this computer and retry.',
    remoteDeviceLimit: 'The online computer limit has been reached',
    remoteRegistrationLimit: 'The registered computer limit has been reached',
    remoteLoginExpired: 'Your sign-in has expired. Please sign in again.',
    remoteLoginFailed: 'Could not open the sign-in page. Please retry.',
    remoteScreenLocked: 'Screen locked',
    remoteRenameDevice: 'Rename device',
    remoteRenameHint: 'Changes only the display name in LobsterAI, up to 100 characters.',
    remoteNameInvalid: 'Enter 1–100 characters without line breaks or control characters.',
    remoteNameSaved: 'Device name updated',
    remoteSavedPending: 'Saved. Will sync when connected.',
    remoteNamePending: 'Name waiting to sync',
    remoteSettingsPending: 'Settings waiting to sync',
    remoteDisabledPending: 'Turned off locally. Will sync when connected.',
    remoteSettingsSaved: 'Settings saved',
    remoteUnsavedChanges: 'Changes are not saved. Select Save below to apply them.',
    remoteAccountChanged: 'Your account changed. Review the mobile control settings again.',
    remoteConnectionFailed: 'Connection failed',
    remoteCredentialInvalid: 'Device verification failed. If reconnecting does not restore access, contact support.',
    remoteReconnect: 'Reconnect',
    remoteReconnectFailed: 'Could not reconnect. Please try again later.',
    remoteRetryOnSave: 'Retry on save',
    remoteStateUnavailable: 'Device status is temporarily unavailable. Please try again.',
    ...
    coworkApproveOnce: 'Allow once',
    coworkApproveAlways: 'Always allow',
    coworkApprovalSubmitting: 'Submitting. Please wait…',
    coworkApprovalUnknown: 'Checking the result. Please do not submit again.',
    coworkApprovalExpired: 'This approval has expired. Updating its status.',
    coworkApprovalNotApplied: 'The decision was not applied. Check the latest approval state.',
    coworkDeny: 'Deny',
    coworkConfirmSelection: 'Submit selection',
    coworkQuestionSubmitFailed: 'Submission failed. Please try again.',
