...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    mcpInstallFromUrlHint: '支持 npm 包名（如 @modelcontextprotocol/server-filesystem）、npx 命令或 HTTP/HTTPS URL',
            ...
            mcpJsonMode: 'JSON 导入',
            mcpFormMode: '表单',
            mcpJsonPlaceholder: '粘贴 MCP 配置 JSON，格式如下：\n{\n  "name": "my-server",\n  "transportType": "stdio",\n  "command": "npx",\n  "args": ["-y", "@some/mcp-server"],\n  "env": { "API_KEY": "your-key" }\n}',
            mcpJsonParseError: 'JSON 格式错误，请检查后重试',
            mcpJsonImport: '解析并导入',
            mcpJsonImportSuccess: '解析成功，已填入表单',
            mcpJsonNoServer: '未能从 JSON 中识别出服务器配置',
  ...
  en: {
    ...
    mcpInstallFromUrlHint: 'Supports npm package names (e.g. @modelcontextprotocol/server-filesystem), npx commands, or HTTP/HTTPS URLs',
            ...
            mcpJsonMode: 'JSON Import',
            mcpFormMode: 'Form',
            mcpJsonPlaceholder: 'Paste MCP config JSON, e.g.:\n{\n  "name": "my-server",\n  "transportType": "stdio",\n  "command": "npx",\n  "args": ["-y", "@some/mcp-server"],\n  "env": { "API_KEY": "your-key" }\n}',
            mcpJsonParseError: 'Invalid JSON format, please check and retry',
            mcpJsonImport: 'Parse & Import',
            mcpJsonImportSuccess: 'Parsed successfully, form has been filled',
            mcpJsonNoServer: 'Could not find any server config in the JSON',
