...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    useSystemProxyDescription: '开启后网络请求将跟随系统代理（保存后生效）',
     ...
     sessionStatsTitle: '使用统计',
     sessionStatsTotalSessions: '总会话数',
     sessionStatsTotalMessages: '总消息数',
     sessionStatsToday: '今日新建会话',
     sessionStatsThisWeek: '本周新建会话',
     sessionStatsAvgMessages: '平均每会话消息数',
     sessionStatsByAgent: '按 Agent 分布',
     sessionStatsUnavailable: '暂无统计数据',
  ...
  en: {
    ...
    useSystemProxyDescription: 'When enabled, network requests follow system proxy settings (applies after Save)',
     ...
     sessionStatsTitle: 'Usage Statistics',
     sessionStatsTotalSessions: 'Total Sessions',
     sessionStatsTotalMessages: 'Total Messages',
     sessionStatsToday: 'Sessions Today',
     sessionStatsThisWeek: 'Sessions This Week',
     sessionStatsAvgMessages: 'Average Messages per Session',
     sessionStatsByAgent: 'Distribution by Agent',
     sessionStatsUnavailable: 'No statistics available',
