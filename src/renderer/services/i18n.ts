...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    scheduledTasksUnsavedChangesTitle: '放弃未保存的修改？',
    scheduledTasksUnsavedChangesMessage: '你有未保存的修改，离开后将丢失这些更改。',
    scheduledTasksUnsavedChangesContinueEditing: '继续编辑',
    scheduledTasksUnsavedChangesDiscard: '放弃修改',
  ...
  en: {
    ...
    scheduledTasksUnsavedChangesTitle: 'Discard unsaved changes?',
    scheduledTasksUnsavedChangesMessage: 'You have unsaved changes that will be lost if you leave.',
    scheduledTasksUnsavedChangesContinueEditing: 'Continue Editing',
    scheduledTasksUnsavedChangesDiscard: 'Discard',
