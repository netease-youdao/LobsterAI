...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    gmailWatcherTitle: 'Gmail 邮件触发',
    gmailWatcherDescription: '新邮件到达时自动触发 Agent 处理',
    gmailWatcherEnable: '启用 Gmail 触发',
    gmailWatcherDisable: '停用',
    gmailWatcherConnect: '连接 Gmail 账号',
    gmailWatcherDisconnect: '断开连接',
    gmailWatcherConnected: '已连接',
    gmailWatcherNotConnected: '未连接',
    gmailWatcherClientId: 'Google OAuth Client ID',
    gmailWatcherClientSecret: 'Google OAuth Client Secret',
    gmailWatcherLabelFilter: '监听标签',
    gmailWatcherPromptTemplate: 'Agent 提示词模板',
    gmailWatcherPollingInterval: '轮询间隔（秒）',
    gmailWatcherRunning: '运行中',
    gmailWatcherStopped: '已停止',
  ...
  en: {
    ...
    gmailWatcherTitle: 'Gmail Trigger',
    gmailWatcherDescription: 'Automatically trigger Agent when new emails arrive',
    gmailWatcherEnable: 'Enable Gmail Trigger',
    gmailWatcherDisable: 'Disable',
    gmailWatcherConnect: 'Connect Gmail Account',
    gmailWatcherDisconnect: 'Disconnect',
    gmailWatcherConnected: 'Connected',
    gmailWatcherNotConnected: 'Not Connected',
    gmailWatcherClientId: 'Google OAuth Client ID',
    gmailWatcherClientSecret: 'Google OAuth Client Secret',
    gmailWatcherLabelFilter: 'Watch Label',
    gmailWatcherPromptTemplate: 'Agent Prompt Template',
    gmailWatcherPollingInterval: 'Polling Interval (seconds)',
    gmailWatcherRunning: 'Running',
    gmailWatcherStopped: 'Stopped',
