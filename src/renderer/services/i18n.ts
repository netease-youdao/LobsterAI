...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    agentImportExport: '导入 / 导出',
    agentExport: '导出',
    agentExportSelectHint: '选择要导出的 Agent',
    agentExportSelectAll: '全选',
    agentImport: '导入',
    agentImportConflictTitle: '导入冲突',
    agentImportConflictDesc: '以下 Agent 与已有配置冲突，请选择处理方式：',
    agentImportConflictOverwrite: '覆盖',
    agentImportConflictCreateNew: '创建为新 Agent',
    agentImportConflictSkip: '跳过',
    agentImportSuccess: '导入成功',
    agentImportSuccessCount: '已成功导入 {count} 个 Agent',
    agentImportError: '导入失败',
    agentExportSuccess: '导出成功',
    agentExportError: '导出失败',
  ...
  en: {
    ...
    agentImportExport: 'Import / Export',
    agentExport: 'Export',
    agentExportSelectHint: 'Select Agents to export',
    agentExportSelectAll: 'Select All',
    agentImport: 'Import',
    agentImportConflictTitle: 'Import Conflicts',
    agentImportConflictDesc: 'The following Agents conflict with existing ones. Choose how to handle each:',
    agentImportConflictOverwrite: 'Overwrite',
    agentImportConflictCreateNew: 'Create as New',
    agentImportConflictSkip: 'Skip',
    agentImportSuccess: 'Import Successful',
    agentImportSuccessCount: 'Successfully imported {count} Agent(s)',
    agentImportError: 'Import Failed',
    agentExportSuccess: 'Export Successful',
    agentExportError: 'Export Failed',
