...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    'sidebar.promptTemplates': 'Prompt 模板',
    'promptTemplates.title': 'Prompt 模板库',
    'promptTemplates.edit': '编辑模板',
    'promptTemplates.delete': '删除',
    'promptTemplates.deleteConfirm': '确定要删除模板「{title}」吗？此操作不可撤销。',
    'promptTemplates.variableFill.title': '填写模板变量',
    'promptTemplates.variableFill.confirm': '确认并填入',
    'promptTemplates.use': '使用',
    'promptTemplates.usedCount': '已使用 {count} 次',
    'promptTemplates.star': '收藏',
    'promptTemplates.unstar': '取消收藏',
    'promptTemplates.createNew': '新建模板',
    'promptTemplates.createTitle': '新建模板',
    'promptTemplates.editTitle': '编辑模板',
    'promptTemplates.createFirst': '创建第一个模板',
    'promptTemplates.searchPlaceholder': '搜索模板...',
    'promptTemplates.categoryAll': '全部',
    'promptTemplates.emptyState': '还没有模板，点击「新建模板」开始创建',
    'promptTemplates.noResults': '没有找到匹配的模板',
    'promptTemplates.saveError': '保存模板失败，请重试',
    'promptTemplates.deleteError': '删除模板失败，请重试',
    'promptTemplates.varTypeText': '文本',
    'promptTemplates.varTypeSelect': '选项',
    'promptTemplates.varLabelPlaceholder': '显示名称（可选）',
    'promptTemplates.varDefaultPlaceholder': '默认值（可选）',
    'promptTemplates.varOptionsPlaceholder': '每行一个选项',
    'promptTemplates.fieldTitle': '模板标题',
    'promptTemplates.fieldTitlePlaceholder': '输入模板标题',
    'promptTemplates.fieldContent': '模板内容',
    'promptTemplates.fieldContentPlaceholder': '输入模板内容，使用 {{变量名}} 插入变量',
    'promptTemplates.fieldDescription': '描述（可选）',
    'promptTemplates.fieldDescriptionPlaceholder': '简要描述模板用途',
    'promptTemplates.fieldCategory': '分类（可选）',
    'promptTemplates.fieldCategoryPlaceholder': '输入或选择分类',
    'promptTemplates.fieldVariables': '变量设置',
    'promptTemplates.variableFill.subtitle': '请填写模板「{title}」中的变量',
    'promptTemplates.variableFill.selectPlaceholder': '请选择...',
    'promptTemplates.copy': '复制',
    'promptTemplates.copySuccess': '模板内容已复制到剪贴板',
    'promptTemplates.copyError': '复制失败，请手动复制',
    'promptTemplates.variableFill.copyConfirm': '确认并复制',
    'promptTemplates.tips.title': '使用指南',
    'promptTemplates.tips.variableSyntax': '变量语法',
    'promptTemplates.tips.variableSyntaxDesc': '在模板内容中使用 {{变量名}} 来定义变量，使用时会弹出填写弹窗。例如：请帮我写一篇关于{{topic}}的{{type}}。',
    'promptTemplates.tips.systemVariables': '系统变量',
    'promptTemplates.tips.systemVariablesDesc': '全大写变量会自动解析，无需手动填写：{{DATE}}（当前日期）、{{TIME}}（当前时间）、{{LANGUAGE}}（当前语言）。',
    'promptTemplates.tips.variableTypes': '变量类型',
    'promptTemplates.tips.variableTypesDesc': '文本：自由输入内容；选项：预设下拉列表供选择。在编辑模板时可设置变量类型和默认值。',
    'promptTemplates.tips.useVsCopy': '使用 vs 复制',
    'promptTemplates.tips.useVsCopyDesc': '"使用"会将模板内容填入新对话的输入框；"复制"会将解析后的内容复制到剪贴板，可粘贴到已有对话中使用。',
  },
  en: {
    // Common
    save: 'Save',
    ...
    'sidebar.promptTemplates': 'Templates',
    'promptTemplates.title': 'Prompt Template Library',
    'promptTemplates.edit': 'Edit Template',
    'promptTemplates.delete': 'Delete',
    'promptTemplates.deleteConfirm': 'Are you sure you want to delete template "{title}"? This action cannot be undone.',
    'promptTemplates.variableFill.title': 'Fill Template Variables',
    'promptTemplates.variableFill.confirm': 'Confirm & Insert',
    'promptTemplates.use': 'Use',
    'promptTemplates.usedCount': 'Used {count} times',
    'promptTemplates.star': 'Star',
    'promptTemplates.unstar': 'Unstar',
    'promptTemplates.createNew': 'New Template',
    'promptTemplates.createTitle': 'Create Template',
    'promptTemplates.editTitle': 'Edit Template',
    'promptTemplates.createFirst': 'Create your first template',
    'promptTemplates.searchPlaceholder': 'Search templates...',
    'promptTemplates.categoryAll': 'All',
    'promptTemplates.emptyState': 'No templates yet. Click "New Template" to get started.',
    'promptTemplates.noResults': 'No matching templates found',
    'promptTemplates.saveError': 'Failed to save template, please try again',
    'promptTemplates.deleteError': 'Failed to delete template, please try again',
    'promptTemplates.varTypeText': 'Text',
    'promptTemplates.varTypeSelect': 'Select',
    'promptTemplates.varLabelPlaceholder': 'Display label (optional)',
    'promptTemplates.varDefaultPlaceholder': 'Default value (optional)',
    'promptTemplates.varOptionsPlaceholder': 'One option per line',
    'promptTemplates.fieldTitle': 'Template Title',
    'promptTemplates.fieldTitlePlaceholder': 'Enter template title',
    'promptTemplates.fieldContent': 'Template Content',
    'promptTemplates.fieldContentPlaceholder': 'Enter template content. Use {{variableName}} to insert variables',
    'promptTemplates.fieldDescription': 'Description (optional)',
    'promptTemplates.fieldDescriptionPlaceholder': 'Brief description of the template',
    'promptTemplates.fieldCategory': 'Category (optional)',
    'promptTemplates.fieldCategoryPlaceholder': 'Enter or select a category',
    'promptTemplates.fieldVariables': 'Variable Settings',
    'promptTemplates.variableFill.subtitle': 'Fill in the variables for template "{title}"',
    'promptTemplates.variableFill.selectPlaceholder': 'Please select...',
    'promptTemplates.copy': 'Copy',
    'promptTemplates.copySuccess': 'Template content copied to clipboard',
    'promptTemplates.copyError': 'Copy failed, please copy manually',
    'promptTemplates.variableFill.copyConfirm': 'Confirm & Copy',
    'promptTemplates.tips.title': 'Usage Guide',
    'promptTemplates.tips.variableSyntax': 'Variable Syntax',
    'promptTemplates.tips.variableSyntaxDesc': 'Use {{variableName}} in template content to define variables. When used, a fill dialog will appear. Example: Write a {{type}} about {{topic}}.',
    'promptTemplates.tips.systemVariables': 'System Variables',
    'promptTemplates.tips.systemVariablesDesc': 'ALL_CAPS variables are resolved automatically: {{DATE}} (current date), {{TIME}} (current time), {{LANGUAGE}} (current language).',
    'promptTemplates.tips.variableTypes': 'Variable Types',
    'promptTemplates.tips.variableTypesDesc': 'Text: free text input; Select: preset dropdown options. Configure variable type and default value when editing a template.',
    'promptTemplates.tips.useVsCopy': 'Use vs Copy',
    'promptTemplates.tips.useVsCopyDesc': '"Use" inserts template content into a new chat input; "Copy" copies the resolved content to clipboard for pasting into existing conversations.',
  }
};
