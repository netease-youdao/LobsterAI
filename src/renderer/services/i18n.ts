...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    artifactMermaidPreview: '查看预览',
    artifactMermaidSource: '查看源码',
    artifactRenderError: '图表渲染失败',
    artifactClose: '关闭',
    artifactHtmlPreview: 'HTML 预览',
    artifactReactPreview: 'React 预览',
  ...
  en: {
    ...
    artifactMermaidPreview: 'View preview',
    artifactMermaidSource: 'View source',
    artifactRenderError: 'Diagram render failed',
    artifactClose: 'Close',
    artifactHtmlPreview: 'HTML Preview',
    artifactReactPreview: 'React Preview',
