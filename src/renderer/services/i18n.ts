...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    bookmarks: '书签',
    bookmarksEmpty: '暂无书签',
    bookmarksEmptyHint: '将鼠标悬停在消息上，点击书签图标来收藏重要消息。',
    bookmarkJumpTo: '跳转到消息',
    bookmarksGlobalEmptyHint: '在任意对话中收藏重要消息，即可在此统一查看和跳转。',
    coworkExportAs: '导出为',
  ...
  en: {
    ...
    bookmarksEmptyHint: 'Hover over a message and click the bookmark icon to save important messages.',
    bookmarkJumpTo: 'Jump to message',
    bookmarksGlobalEmptyHint: 'Bookmark important messages in any conversation to view and jump to them here.',
