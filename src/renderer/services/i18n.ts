...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    mcpFormModeManual: '手动配置',
    mcpFormModeJson: 'JSON 配置',
    mcpPasteJsonPlaceholder: '粘贴 MCP JSON 配置...',
    mcpPasteJsonParse: '保存',
    mcpPasteJsonParseError: 'JSON 解析失败',
    mcpPasteJsonFound: '发现 {count} 个服务器',
    mcpPasteJsonDuplicate: '已存在',
    mcpPasteJsonNoName: '请输入名称',
    mcpPasteJsonConfirm: '添加 {count} 个服务器',
    mcpPasteJsonBack: '返回',
    mcpPasteSomeFailed: '部分服务器创建失败：{names}',
  ...
  en: {
    ...
    mcpFormModeManual: 'Manual',
    mcpFormModeJson: 'JSON Config',
    mcpPasteJsonPlaceholder: 'Paste MCP JSON config...',
    mcpPasteJsonParse: 'Save',
    mcpPasteJsonParseError: 'Failed to parse JSON',
    mcpPasteJsonFound: 'Found {count} server(s)',
    mcpPasteJsonDuplicate: 'Already exists',
    mcpPasteJsonNoName: 'Enter name',
    mcpPasteJsonConfirm: 'Add {count} Server(s)',
    mcpPasteJsonBack: 'Back',
    mcpPasteSomeFailed: 'Some servers failed: {names}',
