...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    agentSkills: '技能',
    agentSkillsHint: '选择该专家可使用的技能。不选则使用所有已启用技能。',
    agentSkillsSearch: '搜索技能...',
    agentSkillsNone: '点击选择技能',
    agentsSubtitle: '探索和创建专家，让工作生活更高效',
    presetAgents: '专家社区',
    myCustomAgents: '我的专家',
    createNewAgent: '创建专家',
    switchToAgent: '开始聊天',
    ...
    agentIMBound: '已绑定',
    agentIMBindHint: '选择此专家响应的 IM 渠道',
    ...
    confirmDeleteAgentMessage: '删除后无法恢复，确定要删除该 Agent 吗？',
    editAgent: '编辑',
    startChatWithAgent: '开始聊天',
    searchExperts: '搜索专家',
    searchExpertsNoResults: '未找到匹配专家',
  ...
  en: {
    ...
    agentSkills: 'Skills',
    agentSkillsHint: 'Select skills available to this expert. Leave empty to use all enabled skills.',
    agentSkillsSearch: 'Search skills...',
    agentSkillsNone: 'Click to select skills',
    agentsSubtitle: 'Explore and create experts to boost your work and life',
    presetAgents: 'Expert Community',
    myCustomAgents: 'My Experts',
    createNewAgent: 'Create Expert',
    switchToAgent: 'Start Chat',
    addAgent: 'Add',
    ...
    agentIMBound: 'Bound',
    agentIMBindHint: 'Select IM channels this expert responds to',
    agentIMBoundToOther: '→ {agent}',
    ...
    confirmDeleteAgentMessage: 'This action cannot be undone. Are you sure you want to delete this Agent?',
    editAgent: 'Edit',
    startChatWithAgent: 'Start Chat',
    searchExperts: 'Search Experts',
    searchExpertsNoResults: 'No matching experts',
