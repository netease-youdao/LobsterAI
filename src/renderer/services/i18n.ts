...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    agentExport: '导出 Agent',
    agentExportSuccess: '已导出',
    agentExportFailed: '导出失败',
    agentImport: '导入 Agent',
    agentImportFromFile: '从文件导入',
    agentImportFromUrl: '从链接导入',
    agentImportUrlPlaceholder: '输入 Agent 配置 JSON 的 URL',
    agentImportUrlFetch: '获取',
    agentImportSuccess: '导入成功',
    agentImportFailed: '导入失败',
    agentImportInvalidFormat: '格式无效，请检查 JSON 文件',
    agentImportNameExists: '已存在同名 Agent，请重命名后重试',
  ...
  en: {
    ...
    agentExport: 'Export Agent',
    agentExportSuccess: 'Exported',
    agentExportFailed: 'Export failed',
    agentImport: 'Import Agent',
    agentImportFromFile: 'Import from File',
    agentImportFromUrl: 'Import from URL',
    agentImportUrlPlaceholder: 'Enter URL of Agent JSON config',
    agentImportUrlFetch: 'Fetch',
    agentImportSuccess: 'Imported successfully',
    agentImportFailed: 'Import failed',
    agentImportInvalidFormat: 'Invalid format, please check the JSON file',
    agentImportNameExists: 'An Agent with this name already exists, please rename and retry',
