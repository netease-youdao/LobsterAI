...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    scheduledTasksStatsTotalRuns: '近30天执行次数',
    scheduledTasksStatsSuccessRate: '成功率',
    scheduledTasksStatsAvgDuration: '平均时长',
    scheduledTasksStatsTop3Failed: '失败最多的任务',
    scheduledTasksStatsTrend: '近7天每日执行',
    scheduledTasksStatsNoData: '暂无统计数据',
    scheduledTasksStatsTimes: '次',
  ...
  en: {
    ...
    scheduledTasksStatsTotalRuns: 'Runs (Last 30d)',
    scheduledTasksStatsSuccessRate: 'Success Rate',
    scheduledTasksStatsAvgDuration: 'Avg Duration',
    scheduledTasksStatsTop3Failed: 'Most Failed Tasks',
    scheduledTasksStatsTrend: 'Daily Runs (Last 7d)',
    scheduledTasksStatsNoData: 'No data yet',
    scheduledTasksStatsTimes: 'runs',
