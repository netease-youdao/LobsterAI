...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    imPopoAesKeyRequired: '开启 POPO 时 AES Key 为必填项，请先填写后再保存或启用',
  ...
  en: {
    ...
    imPopoAesKeyRequired: 'AES Key is required when POPO is enabled. Enter it before saving or turning the bot on.',
