...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    customProviderProfiles: 'Custom 配置',
    customProviderName: '配置名称',
    customProviderNameRequired: 'Custom 配置名称不能为空',
    customProviderNameExists: 'Custom 配置名称已存在，请使用唯一名称',
    customProviderNamesAdjustedImport: '导入时检测到重名，已自动调整部分 Custom 配置名称',
    customProviderActive: '生效中',
    customProviderSetActive: '设为生效',
    customProviderInUse: '当前生效',
    customProviderMinOne: '至少保留一个 Custom 配置',
    addModel: '添加模型',
    editModel: '编辑模型',
    addNewModel: '添加新模型',
    modelName: '模型名称',
  ...
  en: {
    ...
    customProviderProfiles: 'Custom Profiles',
    customProviderName: 'Profile Name',
    customProviderNameRequired: 'Custom profile name is required',
    customProviderNameExists: 'Custom profile name already exists. Use a unique name',
    customProviderNamesAdjustedImport: 'Duplicate custom names were found during import and auto-adjusted',
    customProviderActive: 'Active',
    customProviderSetActive: 'Set Active',
    customProviderInUse: 'In Use',
    customProviderMinOne: 'At least one custom profile is required',
    addModel: 'Add Model',
