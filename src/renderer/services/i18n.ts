...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    scheduledTasksFormPromptTemplateDailySummaryText: '请总结今天的工作进展，列出已完成的事项、遇到的问题以及明日待办清单。',
    scheduledTasksFormPromptTemplateDataCheck: '数据巡检',
    scheduledTasksFormPromptTemplateDataCheckText: '检查项目中的最新日志和运行状态，如发现异常请给出简要报告和修复建议。',
    scheduledTasksFormPromptTemplateCodeReview: '代码审查',
    scheduledTasksFormPromptTemplateCodeReviewText: '对最近提交的代码进行审查，指出潜在的 Bug、性能问题和不符合最佳实践的写法。',
    ...
    scheduledTasksFormCronQuickEvery15min: '每 15 分钟',
     ...
     scheduledTasksFormAgent: '执行 Agent',
     scheduledTasksFormAgentDefault: '默认 Agent',
     scheduledTasksDetailAgent: '执行 Agent',
  ...
  en: {
    ...
    scheduledTasksFormPromptTemplateDailySummaryText: 'Please summarize today\'s work progress, list completed items, blockers encountered, and tomorrow\'s to-do list.',
    scheduledTasksFormPromptTemplateDataCheck: 'Data inspection',
    scheduledTasksFormPromptTemplateDataCheckText: 'Check the latest logs and runtime status of the project. If anomalies are found, provide a brief report and fix suggestions.',
    scheduledTasksFormPromptTemplateCodeReview: 'Code review',
    scheduledTasksFormPromptTemplateCodeReviewText: 'Review the latest code commits for potential bugs, performance issues, and deviations from best practices.',
    ...
    scheduledTasksFormCronQuickEvery15min: 'Every 15 minutes',
     scheduledTasksFormPayloadTextAgentHint: 'Describe what you want the AI to do. The more detail you provide, the better the results.',
     scheduledTasksFormCharCount: '{count} characters',
     scheduledTasksFormAgent: 'Executing Agent',
     scheduledTasksFormAgentDefault: 'Default Agent',
     scheduledTasksDetailAgent: 'Executing Agent',
