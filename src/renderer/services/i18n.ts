...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    mcpDiscardTitle: '放弃编辑？',
    mcpDiscardMessage: '当前填写的内容尚未保存，确定要放弃吗？',
    mcpDiscardConfirm: '放弃',
    mcpDiscardCancel: '继续编辑',
  ...
  en: {
    ...
    mcpDiscardTitle: 'Discard changes?',
    mcpDiscardMessage: 'You have unsaved changes. Are you sure you want to discard them?',
    mcpDiscardConfirm: 'Discard',
    mcpDiscardCancel: 'Keep editing',
