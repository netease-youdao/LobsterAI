...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    agentIdentityLabel: 'IDENTITY.md',
    agentIdentityHint: 'Agent 的基本信息（名字、emoji 等）',
    agentSoulLabel: 'SOUL.md',
    agentSoulHint: 'Agent 的性格、语气和行为准则',
    agentSaveBtn: '保存',
  ...
  en: {
    ...
    agentIdentityLabel: 'IDENTITY.md',
    agentIdentityHint: 'Agent metadata (name, emoji, etc.)',
    agentSoulLabel: 'SOUL.md',
    agentSoulHint: 'Agent personality, tone, and behavior guidelines',
    agentSaveBtn: 'Save',
