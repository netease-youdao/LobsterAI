...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    scheduledTasksRunSuccess: '任务已开始执行',
    scheduledTasksRunning: '执行中...',
    scheduledTasksTriggered: '已触发运行',
    ...
    scheduledTasksSearchPlaceholder: '搜索任务...',
    scheduledTasksHistorySearchPlaceholder: '搜索任务名称...',
    scheduledTasksHistoryDateRange: '筛选日期',
    scheduledTasksNoSearchResults: '没有匹配的任务',
    scheduledTasksAgentMessage: 'Agent 消息',
    scheduledTasksLastRunTime: '执行时间',
    scheduledTasksLastRun: '上次执行',
    scheduledTasksHistoryNoResults: '没有匹配的历史记录',
    scheduledTasksLoadingMore: '加载中...',
    scheduledTasksNoMoreData: '没有更多数据',
    scheduledTasksStatusDisabled: '未启用',
  ...
  en: {
    ...
    scheduledTasksRunSuccess: 'Task started successfully',
    scheduledTasksRunning: 'Running...',
    scheduledTasksTriggered: 'Triggered',
    ...
    scheduledTasksSearchPlaceholder: 'Search tasks...',
    scheduledTasksHistorySearchPlaceholder: 'Search task name...',
    scheduledTasksHistoryDateRange: 'Filter by Date',
    scheduledTasksNoSearchResults: 'No matching tasks',
    scheduledTasksAgentMessage: 'Agent Message',
    scheduledTasksLastRunTime: 'Execution Time',
    scheduledTasksLastRun: 'Last Run',
    scheduledTasksHistoryNoResults: 'No matching history',
    scheduledTasksLoadingMore: 'Loading...',
    scheduledTasksNoMoreData: 'No more data',
    scheduledTasksStatusDisabled: 'Disabled',
