...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    ownershipCompactSync_waiting_service: "待同步（服务未就绪）",
    ...
    ownershipSync_waiting_service: "已关联，等待服务端支持同步",
  ...
  en: {
    ...
    ownershipCompactSync_waiting_service: "Sync pending (service unavailable)",
    ...
    ownershipSync_waiting_service: "Associated; waiting for server support",
