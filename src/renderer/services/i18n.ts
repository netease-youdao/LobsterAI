...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    progressPanelTabProgress: '当前进程',
    progressPanelTabFiles: '文件',
    progressPanelTitle: '当前进程',
    progressPanelEmpty: '暂无工具执行记录',
    progressPanelHasDiff: '有文件变更',
    progressPanelNoDiff: '无变更预览',
    progressPanelTotalOps: '项操作',
    progressPanelFileOps: '项文件操作',
    progressPanelToggle: '当前进程',
  ...
  en: {
    ...
    progressPanelTabProgress: 'Progress',
    progressPanelTabFiles: 'Files',
    progressPanelTitle: 'Current Progress',
    progressPanelEmpty: 'No tool executions yet',
    progressPanelHasDiff: 'Has file changes',
    progressPanelNoDiff: 'No diff preview',
    progressPanelTotalOps: 'operations',
    progressPanelFileOps: 'file operations',
    progressPanelToggle: 'Progress',
    coworkTodosTitle: 'Todos',
