...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    localInferenceService: 'Ollama 服务',
    ...
    localInferenceExternalServiceHint: 'Ollama 正由外部进程运行，请在 Ollama.app、系统服务或终端中关闭。',
    localInferenceServiceConfigTitle: '服务启动参数',
    localInferenceServiceConfigDescription: '这些值会作为环境变量写入 ollama serve，只在启动或重启 Ollama 服务时生效。',
    localInferenceServiceConfigSaved: 'Ollama 服务参数已保存，下次启动生效。',
    localInferenceServiceConfigSavedRestartRequired: 'Ollama 服务参数已保存，重启 Ollama 服务后生效。',
    localInferenceServiceConfigRestartAppRequired: '当前应用主进程还未加载服务参数能力，请重启应用后再保存。',
    localInferenceServiceConfigCudaHint: '限制 Ollama 可见的 GPU 序号，例如 0,1；留空使用系统默认。',
    localInferenceServiceConfigNumGpuHint: '默认 offload 到 GPU 的层数；-1 表示尽量全放 GPU，0 表示纯 CPU。',
    localInferenceServiceConfigMaxLoadedHint: '同时驻留内存的模型数量；留空使用 Ollama 默认。',
    localInferenceServiceConfigNumParallelHint: '单个模型同时处理的请求数；过高会增加显存和内存压力。',
    localInferenceServiceConfigSchedSpreadHint: '多 GPU 时启用更积极的跨卡调度；留空使用 Ollama 默认。',
    localInferenceServiceConfigRestartHint: '当前服务正在运行，保存后需要重启 Ollama 才会应用。',
    localInferenceServiceConfigStartHint: '保存后下次启动 Ollama 时应用。',
    localInferenceInstall: '安装 Ollama',
    localInferenceInstallOpened: '已打开 Ollama 官方下载页，安装完成后请回到这里刷新状态。',
    ...
    marketplaceDescription: '浏览并安装 Ollama 社区模型',
    ...
    marketplaceSourceOllama: 'Ollama',
    ...
    marketplaceFeaturedTitle: '精选模型',
    marketplaceFeaturedDescription: '社区热门推荐',
    marketplaceTaskFilterLabel: '任务类型',
    marketplaceSizeFilterLabel: '模型大小',
    marketplaceQuantizationLabel: '量化等级',
    ...
    marketplaceFilterSizeAll: '全部',
    marketplaceFilterSizeSmall: '< 4B',
    marketplaceFilterSizeDesktop: '4B-8B',
    marketplaceFilterSizeWorkstation: '8B-14B',
    marketplaceFilterSizeLarge: '> 14B',
    marketplaceFilterQuantizationAll: '全部',
    marketplaceFilterQuantizationQ4: 'Q4',
    marketplaceFilterQuantizationQ5: 'Q5',
    marketplaceFilterQuantizationQ8: 'Q8',
    marketplaceFilterReset: '重置',
    marketplaceSetupTitle: '需要启动 Ollama 服务',
    marketplaceSetupDescription: '请先启动 Ollama 服务后再安装模型',
    ...
    marketplaceNeedsRunning: '安装模型需要 Ollama 服务正在运行',
    marketplaceSetupOllamaAction: '{action} Ollama',
    localInferencePullTitle: '拉取模型',
    localInferencePullHint: '输入 Ollama 模型名并拉取到本机，例如 qwen3:8b。',
    localInferencePullPlaceholder: 'qwen3:8b',
    localInferencePull: '拉取',
    localInferenceCancelPull: '取消拉取',
    localInferencePullDone: '模型 {name} 已拉取完成',
    localInferenceRegisteredModels: '已注册模型',
    localInferenceServiceStopped: 'Ollama 服务未运行，请先启动服务。',
    localInferenceNoModels: '暂无本地模型，请先拉取一个模型。',
    localInferenceNoLoadedModels: '暂无已加载模型，请在本地模型中先加载一个模型。',
    localInferenceOpenModels: '打开本地模型',
    localInferenceLoaded: '已加载',
    localInferenceLoad: '加载',
    localInferenceConfigureLaunch: '配置启动',
    localInferenceUnload: '卸载',
    localInferenceInfer: '推理',
    localInferenceUseOpenClaw: '用于 OpenClaw',
    localInferenceSetOpenClawDone: '已将 {name} 设置为 OpenClaw 本地模型',
    localInferenceSetOpenClawFailed: '设置 OpenClaw 本地模型失败',
    ...
    localInferencePromptPlaceholder: '输入本地推理提示词',
    ...
    localInferenceMetrics: 'tokens: {tokens}, 速度: {speed} tokens/s',
    localInferenceLaunchTitle: '启动模型',
    localInferenceLaunchLifecycleTitle: '管理模型驻留，而非 Ollama 服务进程',
    localInferenceLaunchLifecycleDescription: 'Ollama 服务负责调度。模型默认常驻，只有手动结束时才释放。',
    localInferenceLaunchAutoTitle: '自动填写参数',
    localInferenceLaunchAutoDescription: '根据模型大小和 CPU 线程估算参数；不了解含义时使用默认即可。',
    localInferenceLaunchAutoFormula: '公式：上下文按模型大小估算；线程数=min(逻辑线程-2, 16)。',
    localInferenceLaunchAutoOptimize: '自动优化参数',
    localInferenceLaunchAutoAppliedFallback: '已应用保守参数：上下文 {context}，GPU 层数 {gpuLayers}，线程 {threads}，批处理 {batch}。',
    localInferenceLaunchAutoAppliedWithGpu: '已读取可用 GPU 显存 {memory}：上下文 {context}，GPU 层数 {gpuLayers}，线程 {threads}，批处理 {batch}。',
    ...
    localInferenceLaunchNumGpu: 'GPU 层数',
    localInferenceLaunchNumGpuHint: '送入 GPU 的模型层数；0 表示 CPU，留空使用 Ollama 默认。',
    ...
    localInferenceLaunchAdvancedDescription: '这些参数会写入 Ollama options。不了解含义时保持默认即可。',
    localInferenceLaunchNumBatch: '批处理大小',
    localInferenceLaunchNumBatchHint: '提示词处理批大小；显存紧张时降低。',
    localInferenceLaunchMainGpu: '主 GPU',
    localInferenceLaunchMainGpuHint: '多卡时优先使用的 GPU 序号。',
    localInferenceLaunchLowVram: '低显存模式',
    localInferenceLaunchLowVramHint: '显存不足或频繁换入换出时启用。',
    localInferenceLaunchUseMmap: '内存映射',
    localInferenceLaunchUseMmapHint: '控制是否用 mmap 加载模型。',
    localInferenceLaunchUseMlock: '锁定内存',
    localInferenceLaunchUseMlockHint: '尝试避免模型页被换出；可能需要系统权限。',
  ...
  en: {
    ...
    localInferenceService: 'Ollama Service',
    ...
    localInferenceExternalServiceHint: 'Ollama is running outside this app. Stop it from Ollama.app, the system service, or your terminal.',
    localInferenceServiceConfigTitle: 'Service Startup Parameters',
    localInferenceServiceConfigDescription: 'These values are injected as environment variables for ollama serve and apply only after starting or restarting the service.',
    localInferenceServiceConfigSaved: 'Ollama service parameters saved. They will apply on next start.',
    localInferenceServiceConfigSavedRestartRequired: 'Ollama service parameters saved. Restart Ollama to apply them.',
    ...
    localInferenceServiceConfigCudaHint: 'Limit visible GPU indexes for Ollama, for example 0,1. Leave empty for system default.',
    localInferenceServiceConfigNumGpuHint: 'Default GPU offload layers; -1 tries full GPU offload, 0 means CPU only.',
    localInferenceServiceConfigMaxLoadedHint: 'Number of models allowed to stay loaded at once. Leave empty for Ollama default.',
    localInferenceServiceConfigNumParallelHint: 'Concurrent requests per model. Higher values increase VRAM and memory pressure.',
    localInferenceServiceConfigSchedSpreadHint: 'Enable more aggressive multi-GPU scheduling. Leave empty for Ollama default.',
    localInferenceServiceConfigRestartHint: 'Ollama is running. Restart the service to apply saved values.',
    localInferenceServiceConfigStartHint: 'Saved values apply the next time Ollama starts.',
    localInferenceInstall: 'Install Ollama',
    localInferenceInstallOpened: 'Opened the Ollama download page. Refresh here after installation.',
    ...
    marketplaceDescription: 'Browse and install models from Ollama community',
    ...
    marketplaceFeaturedTitle: 'Featured Models',
    marketplaceFeaturedDescription: 'Popular community recommendations',
    marketplaceTaskFilterLabel: 'Task',
    marketplaceSizeFilterLabel: 'Size',
    marketplaceQuantizationLabel: 'Quantization',
    marketplaceFilterTaskAll: 'All',
    ...
    marketplaceFilterSizeAll: 'All',
    marketplaceFilterSizeSmall: '< 4B',
    marketplaceFilterSizeDesktop: '4B-8B',
    marketplaceFilterSizeWorkstation: '8B-14B',
    marketplaceFilterSizeLarge: '> 14B',
    marketplaceFilterQuantizationAll: 'All',
    marketplaceFilterQuantizationQ4: 'Q4',
    marketplaceFilterQuantizationQ5: 'Q5',
    marketplaceFilterQuantizationQ8: 'Q8',
    marketplaceFilterReset: 'Reset',
    marketplaceSetupTitle: 'Ollama Service Required',
    marketplaceSetupDescription: 'Start the Ollama service before installing models',
    ...
    marketplaceNeedsRunning: 'Ollama must be running to install models',
    marketplaceSetupOllamaAction: '{action} Ollama',
    localInferencePullTitle: 'Pull Model',
    localInferencePullHint: 'Enter an Ollama model name to pull locally, such as qwen3:8b.',
    localInferencePullPlaceholder: 'qwen3:8b',
    localInferencePull: 'Pull',
    localInferenceCancelPull: 'Cancel Pull',
    localInferencePullDone: 'Model {name} has been pulled',
    localInferenceRegisteredModels: 'Registered Models',
    localInferenceServiceStopped: 'Ollama is not running. Start the service first.',
    localInferenceNoModels: 'No local models yet. Pull a model first.',
    localInferenceNoLoadedModels: 'No loaded models. Load a model from Local Models first.',
    localInferenceOpenModels: 'Open Local Models',
    localInferenceLoaded: 'Loaded',
    ...
    localInferenceUseOpenClaw: 'Use for OpenClaw',
    localInferenceSetOpenClawDone: 'Set {name} as the OpenClaw local model',
    localInferenceSetOpenClawFailed: 'Failed to set OpenClaw local model',
    ...
    localInferencePromptPlaceholder: 'Enter a local inference prompt',
    ...
    localInferenceMetrics: 'tokens: {tokens}, speed: {speed} tokens/s',
    localInferenceLaunchTitle: 'Launch Model',
    localInferenceLaunchLifecycleTitle: 'Manage model residency, not the Ollama service process',
    localInferenceLaunchLifecycleDescription: 'Ollama schedules the service. Models stay resident by default and are released only when unloaded manually.',
    localInferenceLaunchAutoTitle: 'Auto-fill Parameters',
    localInferenceLaunchAutoDescription: 'Estimate parameters from model size and CPU threads. Keep defaults if unsure.',
    ...
    localInferenceLaunchAutoAppliedFallback: 'Applied conservative parameters: context {context}, GPU layers {gpuLayers}, threads {threads}, batch {batch}.',
    localInferenceLaunchAutoAppliedWithGpu: 'Detected {memory} available GPU memory: context {context}, GPU layers {gpuLayers}, threads {threads}, batch {batch}.',
    ...
    localInferenceLaunchNumGpu: 'GPU Layers',
    localInferenceLaunchNumGpuHint: 'Model layers sent to GPU; 0 means CPU, empty uses Ollama default.',
    ...
    localInferenceLaunchAdvancedDescription: 'These values are passed to Ollama options. Keep defaults if unsure.',
    ...
    localInferenceLaunchMainGpu: 'Main GPU',
    localInferenceLaunchMainGpuHint: 'Preferred GPU index on multi-GPU machines.',
    localInferenceLaunchLowVram: 'Low VRAM Mode',
    localInferenceLaunchLowVramHint: 'Enable when VRAM is tight or paging is frequent.',
    localInferenceLaunchUseMmap: 'Memory Mapping',
    localInferenceLaunchUseMmapHint: 'Controls whether Ollama loads models with mmap.',
    localInferenceLaunchUseMlock: 'Memory Locking',
    localInferenceLaunchUseMlockHint: 'Attempts to keep model pages from being swapped; may need OS permission.',
