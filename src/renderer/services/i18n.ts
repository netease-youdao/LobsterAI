...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    imageInput: '图像',
    speechInput: '语音输入',
    speechInputDescription: '独立配置语音识别服务，录音会先转成文本，再追加到当前输入框末尾。',
    speechInputProvider: '语音提供商',
    speechInputLanguage: '语音语言',
    speechInputUnavailable: '未配置语音识别服务。请选择 GLM ASR 或 Qwen ASR 并填写 API Key。',
    speechInputInvalidConfig: '语音输入配置无效，请确认已选择提供商并填写 API Key。',
    speechInputUnsupportedTooltip: '当前未配置语音输入，请前往语音设置配置支持的语音模型和 API Key。',
    speechInputGlmHint: 'GLM ASR 默认使用 glm-asr-2512，只需填写 API Key 即可。',
    speechInputQwenHint: 'Qwen ASR 默认使用 qwen3-asr-flash，只需填写 API Key 即可。',
    speechInputTestAction: '测试转录',
    speechInputTestDescription: '用当前语音配置录一小段音频并立即查看转录结果。',
    speechInputTestResult: '测试结果',
    speechInputTestEmptyResult: '转录成功，但返回了空文本。',
    coworkStartRecording: '语音输入',
    coworkStopRecording: '停止',
    coworkTranscribing: '正在转录...',
    coworkMicrophonePermissionDenied: '麦克风权限被拒绝，请检查系统和应用权限设置',
    coworkSpeechTranscriptionFailed: '语音转录失败，请稍后重试',
  ...
  en: {
    ...
    speechInputDescription: 'Configure a dedicated speech recognition service. Recordings are transcribed first, then appended to the current input box.',
    speechInputProvider: 'Speech Provider',
    speechInputLanguage: 'Speech Language',
    speechInputUnavailable: 'Speech input is not configured. Choose GLM ASR or Qwen ASR and provide an API key.',
    speechInputInvalidConfig: 'Speech input configuration is invalid. Please choose a provider and enter an API key.',
    speechInputUnsupportedTooltip: 'Speech input is not configured. Open Speech settings and add a supported model with its API key.',
    speechInputGlmHint: 'GLM ASR uses glm-asr-2512 by default. Only an API key is required.',
    speechInputQwenHint: 'Qwen ASR uses qwen3-asr-flash by default. Only an API key is required.',
    speechInputTestAction: 'Test Transcription',
    speechInputTestDescription: 'Record a short clip with the current speech settings and inspect the transcript immediately.',
    speechInputTestResult: 'Test Result',
    speechInputTestEmptyResult: 'Transcription succeeded, but the returned text is empty.',
    coworkStartRecording: 'Speech Input',
    coworkStopRecording: 'Stop',
    coworkTranscribing: 'Transcribing...',
    coworkMicrophonePermissionDenied: 'Microphone permission was denied. Check system and app permissions.',
    coworkSpeechTranscriptionFailed: 'Speech transcription failed. Please try again.',
