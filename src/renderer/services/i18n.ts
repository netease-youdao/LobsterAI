...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    shortcuts: '快捷键',
    securityTab: '安全',
    securityMonitorTitle: '安全监控',
    securityMonitorDesc: '启用后，将加载安全监控插件（nsp-clawguard），对配置文件、Skill 代码、工具调用等进行安全扫描和审计。关闭后插件不再加载，所有安全检测和数据上报均停止。',
    about: '关于',
    aboutVersion: '版本',
  ...
  en: {
    ...
    securityMonitorTitle: 'Security Monitor',
    securityMonitorDesc: 'When enabled, the security monitoring plugin (nsp-clawguard) is loaded to perform security scans and auditing on configuration files, Skill code, and tool calls. When disabled, the plugin is not loaded and all security checks and data reporting are stopped.',
    about: 'About',
