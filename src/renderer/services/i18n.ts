...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    fileCreated: '文件已创建',
    fileCardRevealInFinder: '在 Finder 中显示',
    fileCardRevealInExplorer: '在资源管理器中显示',
    fileCardCopyPath: '复制路径',
    fileCardCopied: '已复制',
    fileCardWriteSuccess: '已写入',
    fileCardClosePreview: '关闭预览',
  ...
  en: {
    ...
    fileCardRevealInFinder: 'Reveal in Finder',
    fileCardRevealInExplorer: 'Reveal in Explorer',
    fileCardCopyPath: 'Copy Path',
    fileCardCopied: 'Copied',
    fileCardWriteSuccess: 'Written',
    fileCardClosePreview: 'Close Preview',
