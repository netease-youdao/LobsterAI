...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    savedConfigs: '已保存配置',
    saveAsNew: '另存为',
    savedConfigName: '配置名称',
    loadConfig: '加载',
    noSavedConfigs: '暂无已保存的配置',
    savedConfigsLimit: '已达上限（20 条）',
    configNameRequired: '请输入配置名称',
    configNameDuplicate: '配置名称已存在，请换一个名称',
    baseUrlRequired: '请填写 Base URL 后再保存',
    apiKeyRequired: '请填写 API Key 后再保存',
    modelsRequired: '请至少配置一个模型后再保存',
    configSaved: '配置已保存',
    saveAsCurrentConfig: '将当前配置另存为',
    hide: '隐藏',
    add: '添加',
    user: '用户',
    login: '登录',
  ...
  en: {
    ...
    clear: 'Clear',
    show: 'Show',
    // Custom provider saved configs
    savedConfigs: 'Saved Configs',
    saveAsNew: 'Save As New',
    savedConfigName: 'Config Name',
    loadConfig: 'Load',
    noSavedConfigs: 'No saved configs yet',
    savedConfigsLimit: 'Limit reached (20)',
    configNameRequired: 'Please enter a config name',
    configNameDuplicate: 'Config name already exists, please choose another',
    baseUrlRequired: 'Please fill in Base URL before saving',
    apiKeyRequired: 'Please fill in API Key before saving',
    modelsRequired: 'Please add at least one model before saving',
    configSaved: 'Config saved',
    saveAsCurrentConfig: 'Save current config as',
    hide: 'Hide',
    add: 'Add',
    user: 'User',
    login: 'Login',
