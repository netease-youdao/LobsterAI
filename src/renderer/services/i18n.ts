...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    searchChats: '搜索聊天',
    searchConversations: '搜索任务标题或消息内容...',
    searchNoResults: '未找到匹配任务',
    searchMatchedInMessage: '消息内容匹配',
    searchSearching: '搜索中...',
    projects: '项目',
    yourChats: '你的聊天',
    createProject: '新项目',
  ...
  en: {
    ...
    searchConversations: 'Search task titles or message content...',
    searchNoResults: 'No matching tasks',
    searchMatchedInMessage: 'Matched in message',
