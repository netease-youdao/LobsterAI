...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    mcpCommandNotInAllowlist: '命令 "{command}" 不在常见 MCP 命令列表中，确认添加？',
    mcpCommandMetacharError: '命令包含不允许的特殊字符',
    mcpConfirmAddCommand: '确认添加',
  ...
  en: {
    ...
    mcpCommandNotInAllowlist: 'Command "{command}" is not in the common MCP command list. Confirm to add?',
    mcpCommandMetacharError: 'Command contains disallowed special characters',
    mcpConfirmAddCommand: 'Confirm Add',
