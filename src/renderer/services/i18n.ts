...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    scheduledTasksScheduleModeNL: '自然语言',
    scheduledTasksScheduleModeGUI: '手动选择',
    ...
    scheduleParserLabel: '执行时间',
    scheduleParserPlaceholder: '用自然语言描述，例如：每天早上9点',
    scheduleParserConvertButton: '确认',
    scheduleParserConverting: '解析中...',
    scheduleParserNotConverted: '请先解析执行时间',
    scheduleParserCronLabel: 'Cron 表达式：',
    scheduleParserNextRunsLabel: '接下来几次执行时间：',
    scheduleParserRunAt: '执行时间：',
    scheduleParserEmptyInput: '请输入执行时间描述',
    scheduleParserConvertFailed: '解析失败，请检查输入内容',
    scheduleParserInvalidCron: '生成的表达式无效，请重新描述',
    scheduleParserDatetimePast: '指定的时间已过，请选择未来的时间',
    scheduleParserApiNotConfigured: '模型服务不可用，请检查配置',
  ...
  en: {
    ...
    scheduledTasksScheduleModeNL: 'Natural Language',
    scheduledTasksScheduleModeGUI: 'Manual Select',
    ...
    scheduleParserLabel: 'Schedule',
    scheduleParserPlaceholder: 'Describe in natural language, e.g. every day at 9am',
    scheduleParserConvertButton: 'Confirm',
    scheduleParserConverting: 'Parsing...',
    scheduleParserNotConverted: 'Please parse the schedule first',
    scheduleParserCronLabel: 'Cron expression:',
    scheduleParserNextRunsLabel: 'Next scheduled runs:',
    scheduleParserRunAt: 'Runs at:',
    scheduleParserEmptyInput: 'Please enter a schedule description',
    scheduleParserConvertFailed: 'Failed to parse, please check your input',
    scheduleParserInvalidCron: 'Generated expression is invalid, please try again',
    scheduleParserDatetimePast: 'The specified time has passed, please choose a future time',
    scheduleParserApiNotConfigured: 'Model service unavailable, please check configuration',
