...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    coworkToolOutputLinesOne: '1 行输出',
    coworkToolOutputLines: '{n} 行输出',
    ...
    coworkExportSessionSuccess: '导出成功',
    coworkExportSessionFailed: '导出失败',
    coworkExportSessionEmpty: '当前会话无内容可导出',
    deleteSession: '删除任务',
  ...
  en: {
    ...
    coworkToolOutputLinesOne: '1 line of output',
    coworkToolOutputLines: '{n} lines of output',
    ...
    coworkExportSessionSuccess: 'Export successful',
    coworkExportSessionFailed: 'Export failed',
    coworkExportSessionEmpty: 'No content to export in current session',
