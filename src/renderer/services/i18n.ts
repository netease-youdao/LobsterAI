...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    scheduledTasksNoRunsHint: '运行任务后，记录将显示在这里',
  ...
  en: {
    ...
    noSkillsAvailableHint: 'Try installing skills from the marketplace',
    ...
    skillMarketplaceEmptyHint: 'Check back later for new skills',
    ...
    scheduledTasksNoRunsHint: 'Run a task to see its history here',
