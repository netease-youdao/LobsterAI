...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    detectedAnthropicFormat: '自动检测成功，已识别为 Anthropic 兼容格式',
    detectedOpenAIFormat: '自动检测成功，已识别为 OpenAI 兼容格式',
    autoDetectFailed: '自动检测失败，请手动选择 API 格式',
  ...
  en: {
    ...
    detectedAnthropicFormat: 'Auto-detected: Anthropic compatible format',
    detectedOpenAIFormat: 'Auto-detected: OpenAI compatible format',
    autoDetectFailed: 'Auto-detection failed, please select API format manually',
