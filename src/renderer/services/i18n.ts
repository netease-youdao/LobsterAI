...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    scheduledTasksFormAgentDefault: '系统自动',
    scheduledTasksFormAgentUnavailable: '归属 Agent 已被删除，无法保存。请删除此任务后重新创建',
    scheduledTasksFormAgentUnavailableShort: 'Agent 已删除',
  ...
  en: {
    ...
    scheduledTasksFormAgentDefault: 'Auto (main)',
    scheduledTasksFormAgentUnavailable: 'The bound agent has been deleted. Please delete this task and create a new one.',
    scheduledTasksFormAgentUnavailableShort: 'Agent deleted',
