...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    skillImportConflictTitle: '已安装同名技能',
    skillImportConflictMessage: '覆盖更新会用导入的内容替换已安装的技能，并保留其本地配置（.env、accounts.json）。',
    skillImportConflictVersion: '当前版本：{installed} → 导入版本：{incoming}',
    skillImportConflictConfirm: '覆盖更新',
    official: '官方',
  ...
  en: {
    ...
    skillImportConflictTitle: 'Skill already installed',
    skillImportConflictMessage: 'Updating replaces the installed skill with the imported files and keeps its local configuration (.env, accounts.json).',
    skillImportConflictVersion: 'Installed: {installed} → Importing: {incoming}',
    skillImportConflictConfirm: 'Update',
    official: 'Official',
