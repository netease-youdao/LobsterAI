      ...
      case 'general':
        return (
          <div className="space-y-8">
            ...
            {/* Task Completion Notification Section */}
            <div>
              <h4 className="text-sm font-medium text-foreground mb-3">
                {i18nService.t('taskNotification')}
              </h4>
              <label className="flex items-center justify-between cursor-pointer">
                <span className="text-sm text-secondary">
                  {i18nService.t('taskNotificationDescription')}
                </span>
                <button
                  type="button"
                  role="switch"
                  ...
                  className={`relative inline-flex h-6 w-11 flex-shrink-0 items-center rounded-full transition-colors ${
                    taskNotification ? 'bg-primary' : 'bg-gray-300 dark:bg-gray-600'
                  }`}
                >
                  <span
                    className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                      taskNotification ? 'translate-x-6' : 'translate-x-1'
                    }`}
                  />
                </button>
              </label>
