            ...
            <div className="w-2/5 border-r border-border pr-3 space-y-1.5 overflow-y-auto">
                  ...
                  >
                    ...
                    <div className="flex items-center ml-2 gap-1">
                      {isCustom && (
                        <button
                          type="button"
                          className="opacity-0 group-hover:opacity-100 transition-opacity text-secondary hover:text-red-500 dark:hover:text-red-400 p-0.5"
                          onClick={e => {
                            e.stopPropagation();
              ...
              {CUSTOM_PROVIDER_KEYS.some(k => !providers[k]) && (
                <button
                  ...
                  className="w-full flex items-center justify-center p-2 rounded-xl border border-dashed border-border text-secondary hover:border-primary hover:text-primary transition-colors text-sm"
                >
                ...
                <div>
                    ...
                    !providers['github-copilot'].apiKey && (
                      <div className="space-y-2">
                        <button
                          ...
                          className="flex items-center gap-2 px-4 py-2 rounded-xl bg-primary text-white text-xs font-medium hover:bg-primary/90 transition-colors"
                        >
                  ...
                  {(copilotAuthStatus === 'authenticated' || providers['github-copilot'].apiKey) &&
                    ...
                    copilotAuthStatus !== 'polling' && (
                      <div className="flex items-center justify-between p-3 rounded-xl bg-surface-inset border border-border">
                        <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-center space-x-4">
                      <label className="flex items-center">
                        <input
                          ...
                          className="h-3.5 w-3.5 text-primary focus:ring-primary bg-surface disabled:opacity-50"
                        />
        ...
        {pendingDeleteProvider && (
          ...
          >
            <div
              ...
              aria-modal="true"
              onClick={e => e.stopPropagation()}
              className="w-full max-w-sm rounded-2xl bg-background border-border border shadow-modal p-4"
            >
